...
### Added
- Leaderboard chart: Add legend support

### Changed
- Leaderboard chart: Make docs consistent with other charts
...
[0.36.0-alpha]: https://github.com/Automattic/charts/compare/v0.35.0...v0.36.0-alpha
