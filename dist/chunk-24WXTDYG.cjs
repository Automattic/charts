...
var _chunkEW6ETSNZcjs = require('./chunk-EW6ETSNZ.cjs');
...
var BarChartInternal = ({
  ...
  const chartId = _chunkEW6ETSNZcjs.useChartId.call(void 0, providedChartId);
  const theme = _chunkEW6ETSNZcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkEW6ETSNZcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkEW6ETSNZcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkEW6ETSNZcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkEW6ETSNZcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, svgWrapperHeight] = _chunkEW6ETSNZcjs.useElementHeight.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const hasLegendChild = _chunkEW6ETSNZcjs.useHasLegendChild.call(void 0, children);
  ...
  const {
    getElementStyles,
    isSeriesVisible
  } = _chunkEW6ETSNZcjs.useGlobalChartsContext.call(void 0, );
  const providerTheme = _chunkEW6ETSNZcjs.useGlobalChartsTheme.call(void 0, );
  ...
  _chunkEW6ETSNZcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "bar",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkEW6ETSNZcjs.usePrefersReducedMotion.call(void 0, );
  if (error) {
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkEW6ETSNZcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkEW6ETSNZcjs.SingleChartContext.Provider, {
    value: {
      chartId,
      chartWidth: width,
      chartHeight
...
var BarChartWithProvider = (props) => {
  const existingContext = _react.useContext.call(void 0, _chunkEW6ETSNZcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, {
      ...props
    });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkEW6ETSNZcjs.GlobalChartsProvider, {
...
var BarChart = _chunkZVGEDXDPcjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkEW6ETSNZcjs.Legend
});
...
//# sourceMappingURL=chunk-24WXTDYG.cjs.map