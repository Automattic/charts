...
var BarChartInternal = ({
  ...
  const dataWithVisibleZeros = _chunkP2LIEOFQcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues,
    valueAxisLength: horizontal ? width : height
  });
  const legendItems = _chunkHEVMLPZCcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkP2LIEOFQcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const chartRef = _react.useRef.call(void 0, null);
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkLA3Y2O6Ncjs.useChartChildren.call(void 0, children, "BarChart");
...
//# sourceMappingURL=chunk-27RBNWWA.cjs.map