...
var BarChartInternal = ({
  ...
  const dataWithVisibleZeros = _chunkTVV7ZI7Ccjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkTVV7ZI7Ccjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkTVV7ZI7Ccjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
...
var BarChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkTVV7ZI7Ccjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props }) });
};
...
var BarChartResponsive = _chunkZVGEDXDPcjs.attachSubComponents.call(void 0, 
  _chunkHOTYXYXVcjs.withResponsive.call(void 0, BarChartWithProvider),
  {
    Legend: _chunkTVV7ZI7Ccjs.Legend
  }
);
...
//# sourceMappingURL=chunk-3E5WRW5I.cjs.map