...
var LineChartAnnotationsOverlay = ({
  ...
  const {
    ...
    chartWidth,
    chartHeight
  } = _chunk4BAOQYIOcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunk4BAOQYIOcjs.useGlobalChartsTheme.call(void 0, );
  const {
    xScale,
    yScale
  } = _react.useContext.call(void 0, _xychart.DataContext) || {};
...
var LineChartInternal = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const providerTheme = _chunk4BAOQYIOcjs.useGlobalChartsTheme.call(void 0, );
  const theme = _chunk4BAOQYIOcjs.useXYChartTheme.call(void 0, data);
  const chartId = _chunk4BAOQYIOcjs.useChartId.call(void 0, providedChartId);
  const [svgWrapperRef, , svgWrapperHeight] = _chunk4BAOQYIOcjs.useElementSize.call(void 0, );
  ...
  const hasLegendChild = _chunk4BAOQYIOcjs.useHasLegendChild.call(void 0, children);
  ...
  const dataSorted = _chunk4BAOQYIOcjs.useChartDataTransform.call(void 0, data);
  const {
    getElementStyles,
    isSeriesVisible
  ...
  const defaultMargin = _chunk4BAOQYIOcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
  ...
  const legendItems = _chunk4BAOQYIOcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
//# sourceMappingURL=chunk-3HKRMKA5.cjs.map