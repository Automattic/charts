...
var PieChartInternal = ({
  ...
  const [legendRef, legendHeight] = _chunkEW6ETSNZcjs.useElementHeight.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunkEW6ETSNZcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunkEW6ETSNZcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
...
//# sourceMappingURL=chunk-3HRBLD2Y.cjs.map