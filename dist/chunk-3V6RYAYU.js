...
import { useMemo as useMemo2, useContext as useContext4, forwardRef, useImperativeHandle, useState as useState4, useRef as useRef3, createElement as _createElement } from "react";
...
var LineChartInternal = /* @__PURE__ */ forwardRef(({
  ...
  return /* @__PURE__ */ _jsx5(SingleChartContext.Provider, {
    ...
    children: /* @__PURE__ */ _jsxs3(Stack, {
      direction: "column",
      gap,
      className: clsx2("line-chart", line_chart_module_default["line-chart"], {
      ...
      children: [legendPosition === "top" && legendElement, renderLegendSlot(legendChildren, "top"), /* @__PURE__ */ _jsx5("div", {
        ...
        onBlur: onChartBlur,
        children: !isWaitingForMeasurement && /* @__PURE__ */ _jsx5("div", {
          ref: chartRef,
...
//# sourceMappingURL=chunk-3V6RYAYU.js.map