...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkFI5B6KSHcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkPD4ADOLWcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkFI5B6KSHcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkOLHJTLY4cjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkOLHJTLY4cjs.useXYChartTheme.call(void 0, data);
    ...
    const dataSorted = _chunkOLHJTLY4cjs.useChartDataTransform.call(void 0, data);
    ...
    const defaultMargin = _chunkOLHJTLY4cjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkPD4ADOLWcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOLHJTLY4cjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
...
var LineChartResponsive = _chunkFI5B6KSHcjs.attachSubComponents.call(void 0, 
  _chunk5NI3TGRDcjs.withResponsive.call(void 0, LineChartWithProvider),
  {
    Legend: _chunkPD4ADOLWcjs.Legend,
    AnnotationsOverlay: line_chart_annotations_overlay_default,
    Annotation: line_chart_annotation_default
...
//# sourceMappingURL=chunk-433D3G7O.cjs.map