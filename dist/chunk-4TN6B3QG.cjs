...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkMNZD6UDQcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkMNZD6UDQcjs.useGlobalChartsTheme.call(void 0, );
    const context = _react.useContext.call(void 0, _chunkMNZD6UDQcjs.GlobalChartsContext);
