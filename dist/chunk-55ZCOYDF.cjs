...
function useUpdateEffect(effect, deps) {
  const mountedRef = _chunkSUDERBUAcjs.useRef.call(void 0, false);
  _chunkSUDERBUAcjs.useEffect.call(void 0, () => {
...
var useCx = () => {
  ...
  const cx2 = _chunkSUDERBUAcjs.useCallback.call(void 0, (...classNames) => {
    if (cache2 === null) {
...
var ComponentsContext = _chunkSUDERBUAcjs.createContext.call(void 0, 
  /** @type {Record<string, any>} */
  {}
);
ComponentsContext.displayName = "ComponentsContext";
var useComponentsContext = () => _chunkSUDERBUAcjs.useContext.call(void 0, ComponentsContext);
function useContextSystemBridge({
  value
}) {
  const parentContext = useComponentsContext();
  const valueRef = _chunkSUDERBUAcjs.useRef.call(void 0, value);
  ...
  const config = _chunkSUDERBUAcjs.useMemo.call(void 0, () => {
...
var ContextSystemProvider = _chunkSUDERBUAcjs.memo.call(void 0, BaseContextSystemProvider);
...
function _contextConnect(Component, namespace, options) {
  const WrappedComponent = _optionalChain([options, 'optionalAccess', _7 => _7.forwardsRef]) ? _chunkSUDERBUAcjs.forwardRef.call(void 0, Component) : Component;
...
var View = Object.assign(_chunkSUDERBUAcjs.forwardRef.call(void 0, UnforwardedView), {
...
var useBreakpointIndex = (options = {}) => {
  ...
  const [value, setValue] = _chunkSUDERBUAcjs.useState.call(void 0, defaultIndex);
  _chunkSUDERBUAcjs.useEffect.call(void 0, () => {
...
function useFlex(props) {
  ...
  const cx2 = useCx();
  const classes = _chunkSUDERBUAcjs.useMemo.call(void 0, () => {
...
var FlexContext = _chunkSUDERBUAcjs.createContext.call(void 0, {
  flexItemDisplay: void 0
});
var useFlexContext = () => _chunkSUDERBUAcjs.useContext.call(void 0, FlexContext);
...
function createHighlighterText({
  ...
  const textContent = chunks.map((chunk, index) => {
    ...
    if (chunk.highlight) {
      ...
      return _chunkSUDERBUAcjs.createElement.call(void 0, HighlightTag, props);
    }
    return _chunkSUDERBUAcjs.createElement.call(void 0, "span", {
      children: text,
...
function useText(props) {
  ...
  if (!truncate && Array.isArray(children)) {
    content = _chunkSUDERBUAcjs.Children.map(children, (child) => {
      if (typeof child !== "object" || child === null || !("props" in child)) {
        return child;
      }
      const isLink = hasConnectNamespace(child, ["Link"]);
      if (isLink) {
        return _chunkSUDERBUAcjs.cloneElement.call(void 0, child, {
...
function getValidChildren(children) {
  ...
  return _chunkSUDERBUAcjs.Children.toArray(children).filter((child) => _chunkSUDERBUAcjs.isValidElement.call(void 0, child));
}
    ...
    children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", {
      ...
      children: [allSeriesHidden ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
        ...
        children: data.map((entry) => {
          ...
          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkSUDERBUAcjs.Fragment, {
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-55ZCOYDF.cjs.map