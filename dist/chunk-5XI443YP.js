...
var BaseTooltip = ({
  ...
  const content = children || data && /* @__PURE__ */ jsx(Component, { data, className });
  if (!renderContainer) {
    return content;
  }
  return /* @__PURE__ */ jsx("div", { className: base_tooltip_module_default.tooltip, style: { top, left, ...style }, role: "tooltip", children: content });
};
