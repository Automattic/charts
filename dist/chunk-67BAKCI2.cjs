...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunk44EBMDFIcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const context = _react.useContext.call(void 0, _chunk44EBMDFIcjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-67BAKCI2.cjs.map