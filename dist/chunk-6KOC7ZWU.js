...
var BaseTooltip = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: base_tooltip_module_default.tooltip, style: { top, left }, role: "tooltip", children: children || data && /* @__PURE__ */ jsx(Component, { data, className }) });
};
...
var AccessibleTooltip = ({
  ...
  const focusableRenderTooltip = useMemo(() => {
    ...
    return (params) => {
      ...
      return /* @__PURE__ */ jsx2("div", { role: "tooltip", "aria-live": "polite", children: tooltipContent });
    };
  }, [renderTooltip, selectedIndex, tooltipRef, keyboardFocusedClassName]);
  return /* @__PURE__ */ jsx2(Tooltip, { ...props, renderTooltip: focusableRenderTooltip });
};
...
//# sourceMappingURL=chunk-6KOC7ZWU.js.map