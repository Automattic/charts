...
var BarChartInternal = ({
  ...
  const chartId = _chunkN3VZKO2Qcjs.useChartId.call(void 0, providedChartId);
  const theme = _chunkN3VZKO2Qcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkN3VZKO2Qcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkN3VZKO2Qcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkN3VZKO2Qcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkN3VZKO2Qcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, , svgWrapperHeight] = _chunkN3VZKO2Qcjs.useElementSize.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const hasLegendChild = _chunkN3VZKO2Qcjs.useHasLegendChild.call(void 0, children);
  ...
  const {
    getElementStyles,
    isSeriesVisible
  } = _chunkN3VZKO2Qcjs.useGlobalChartsContext.call(void 0, );
  const providerTheme = _chunkN3VZKO2Qcjs.useGlobalChartsTheme.call(void 0, );
  ...
  _chunkN3VZKO2Qcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "bar",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkN3VZKO2Qcjs.usePrefersReducedMotion.call(void 0, );
  if (error) {
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkN3VZKO2Qcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkN3VZKO2Qcjs.SingleChartContext.Provider, {
    value: {
      chartId,
      chartWidth: width,
      chartHeight
...
var BarChartWithProvider = (props) => {
  const existingContext = _react.useContext.call(void 0, _chunkN3VZKO2Qcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, {
      ...props
    });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkN3VZKO2Qcjs.GlobalChartsProvider, {
...
var BarChart = _chunkVTS3PNMScjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkN3VZKO2Qcjs.Legend
});
...
//# sourceMappingURL=chunk-6VO2XKSJ.cjs.map