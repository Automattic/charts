...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkTEEQFJFLcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkTEEQFJFLcjs.useGlobalChartsTheme.call(void 0, );
...
var Legend = _react.forwardRef.call(void 0, 
  ({ chartId, items, ...props }, ref) => {
    const context = _react.useContext.call(void 0, _chunkTEEQFJFLcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkTEEQFJFLcjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
//# sourceMappingURL=chunk-76XOLO7F.cjs.map