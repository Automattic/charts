...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkYMPBXVE6cjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkADMNTUXLcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkYMPBXVE6cjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkYMPBXVE6cjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkYMPBXVE6cjs.useXYChartTheme.call(void 0, data);
    ...
    const dataSorted = _chunkYMPBXVE6cjs.useChartDataTransform.call(void 0, data);
    ...
    const defaultMargin = _chunkYMPBXVE6cjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkADMNTUXLcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
                    ...
                    _xychart.XYChart,
                    {
                      ...
                      children: [
                        ...
                        dataSorted.map((seriesData, index) => {
                          ...
                          const lineStyles = _chunkYMPBXVE6cjs.getSeriesLineStyles.call(void 0, seriesData, index, providerTheme);
                          const lineProps = {
                            stroke,
                            ...lineStyles
                          };
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYMPBXVE6cjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkYMPBXVE6cjs.attachSubComponents.call(void 0, LineChartWithProvider, {
...
var LineChartResponsive = _chunkYMPBXVE6cjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-AACSXIXO.cjs.map