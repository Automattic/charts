...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkMEHVGZ6Ucjs.useSingleChartContext.call(void 0, );
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkBJKZ4CCEcjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkBJKZ4CCEcjs.useXYChartTheme.call(void 0, data);
    ...
    const dataSorted = _chunkBJKZ4CCEcjs.useChartDataTransform.call(void 0, data);
    ...
    const defaultMargin = _chunkBJKZ4CCEcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkMEHVGZ6Ucjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkBJKZ4CCEcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
...
//# sourceMappingURL=chunk-AB2UWGQA.cjs.map