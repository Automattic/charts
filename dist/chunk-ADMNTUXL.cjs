...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkYMPBXVE6cjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const context = _react.useContext.call(void 0, _chunkYMPBXVE6cjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkYMPBXVE6cjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
function processSeriesData(seriesData, theme, showValues, withGlyph, glyphSize, renderGlyph, legendShape) {
  const mapper = (series, index) => {
    const { shapeStyles } = _chunkYMPBXVE6cjs.getItemShapeStyles.call(void 0, series, index, theme, legendShape);
    const baseItem = {
      label: series.label,
      ...
      color: _chunkYMPBXVE6cjs.getSeriesStroke.call(void 0, series, index, theme.colors),
...
//# sourceMappingURL=chunk-ADMNTUXL.cjs.map