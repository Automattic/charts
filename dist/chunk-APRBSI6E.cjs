...
var BarChartInternal = ({
  ...
  const chartId = _chunkZMKLYXJNcjs.useChartId.call(void 0, providedChartId);
  const theme = _chunkZMKLYXJNcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkZMKLYXJNcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkZMKLYXJNcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkZMKLYXJNcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkZMKLYXJNcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, , svgWrapperHeight] = _chunkZMKLYXJNcjs.useElementSize.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const hasLegendChild = _chunkZMKLYXJNcjs.useHasLegendChild.call(void 0, children);
  ...
  const providerTheme = _chunkZMKLYXJNcjs.useGlobalChartsTheme.call(void 0, );
  ...
  _chunkZMKLYXJNcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "bar",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkZMKLYXJNcjs.usePrefersReducedMotion.call(void 0, );
  if (error) {
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkZMKLYXJNcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkZMKLYXJNcjs.SingleChartContext.Provider, {
    value: {
      chartId,
      chartWidth: width,
      chartHeight
...
var BarChart = _chunkVTS3PNMScjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkZMKLYXJNcjs.Legend
});
...
//# sourceMappingURL=chunk-APRBSI6E.cjs.map