...
var PieChartInternal = ({
  ...
  const [svgWrapperRef, svgWrapperWidth, svgWrapperHeight] = _chunk4BAOQYIOcjs.useElementSize.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunk4BAOQYIOcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunk4BAOQYIOcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
...
//# sourceMappingURL=chunk-AUZSPEIT.cjs.map