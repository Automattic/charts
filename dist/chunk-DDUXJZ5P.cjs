...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkTEEQFJFLcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunk76XOLO7Fcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunkTEEQFJFLcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkTEEQFJFLcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkTEEQFJFLcjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkTEEQFJFLcjs.useXYChartTheme.call(void 0, data);
    const chartId = _chunkTEEQFJFLcjs.useChartId.call(void 0, providedChartId);
    const [legendRef, legendHeight] = _chunkTEEQFJFLcjs.useElementHeight.call(void 0, );
    ...
    const dataSorted = _chunkTEEQFJFLcjs.useChartDataTransform.call(void 0, data);
    ...
    const defaultMargin = _chunkTEEQFJFLcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunk76XOLO7Fcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkTEEQFJFLcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkTEEQFJFLcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
...
var LineChartResponsive = _chunkTEEQFJFLcjs.attachSubComponents.call(void 0, 
