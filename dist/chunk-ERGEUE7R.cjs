...
var ConversionFunnelChartInternal = ({
  ...
  const { conversionFunnelChart: conversionFunnelChartSettings } = _chunkW3H42XRVcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const barBackgroundColor = backgroundColor || _optionalChain([_d3color.color.call(void 0, barColor), 'optionalAccess', _7 => _7.copy, 'call', _8 => _8({ opacity: 0.08 }), 'access', _9 => _9.formatRgb, 'call', _10 => _10()]) || "rgba(0, 0, 0, 0.08)";
  const renderDefaultMainMetric = () => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: conversion_funnel_chart_module_default["main-rate"], children: _chunkDAKYGZG6cjs.formatPercentage.call(void 0, mainRate) }),
  ...
  const renderDefaultTooltip = (step) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: conversion_funnel_chart_module_default["tooltip-content"], children: [
      _chunkDAKYGZG6cjs.formatPercentage.call(void 0, step.rate),
  ...
  const chartMetadata = _react.useMemo.call(void 0, 
    () => ({
      mainRate,
      changeIndicator,
      stepsCount: _optionalChain([steps, 'optionalAccess', _11 => _11.length]) || 0
    }),
    [mainRate, changeIndicator, _optionalChain([steps, 'optionalAccess', _12 => _12.length])]
  );
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: conversion_funnel_chart_module_default["step-header"], children: [
                    ...
                    }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: conversion_funnel_chart_module_default["step-rate"], children: _chunkDAKYGZG6cjs.formatPercentage.call(void 0, step.rate) })
                  ] }),
                  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                    "div",
                    {
                      ...
                      onClick: _optionalChain([stepHandlers, 'access', _13 => _13.get, 'call', _14 => _14(step.id), 'optionalAccess', _15 => _15.onClick]),
                      onKeyDown: _optionalChain([stepHandlers, 'access', _16 => _16.get, 'call', _17 => _17(step.id), 'optionalAccess', _18 => _18.onKeyDown]),
                      role: "button",
...
var ConversionFunnelChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkW3H42XRVcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ConversionFunnelChartInternal, { ...props }) });
};
...
//# sourceMappingURL=chunk-ERGEUE7R.cjs.map