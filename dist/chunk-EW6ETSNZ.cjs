...
var useChartMargin = (height, options, data, theme, horizontal = false) => {
  const yTicks = _react.useMemo.call(void 0, () => {
    ...
    if (horizontal) {
      return allDataPoints.map((d) => d.label || _optionalChain([options, 'access', _14 => _14.axis, 'optionalAccess', _15 => _15.y, 'optionalAccess', _16 => _16.tickFormat, 'call', _17 => _17(d.date.getTime(), 0, [])]));
    }
  ...
  return _react.useMemo.call(void 0, () => {
    ...
    const yTickWidth = _chunkZVGEDXDPcjs.getLongestTickWidth.call(void 0, yTicks, _optionalChain([options, 'access', _24 => _24.axis, 'optionalAccess', _25 => _25.y, 'optionalAccess', _26 => _26.tickFormat]), yAxisStyles.axisLabel);
...
var BaseLegend = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const getShapeStyle = _react.useCallback.call(void 0, ({
    index
  }) => _optionalChain([items, 'access', _31 => _31[index], 'optionalAccess', _32 => _32.shapeStyle]), [items]);
    ...
    children: (labels) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
      ...
      children: labels.map((label, i) => {
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _legend.LegendItem, {
          ...
          ...legendItemProps,
          children: [_optionalChain([items, 'access', _33 => _33[i], 'optionalAccess', _34 => _34.renderGlyph]) ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "svg", {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _group.Group, {
              children: _optionalChain([items, 'access', _39 => _39[i], 'optionalAccess', _40 => _40.renderGlyph, 'call', _41 => _41({
            ...
            children: [/* @__PURE__ */ _jsxruntime.jsx.call(void 0, LegendText, {
              ...
              textOverflow,
              maxWidth
            }), _optionalChain([items, 'access', _48 => _48.find, 'call', _49 => _49((item) => item.label === label.text), 'optionalAccess', _50 => _50.value]) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", {
              className: base_legend_module_default["legend-item-value"],
              children: ["\xA0", _optionalChain([items, 'access', _51 => _51.find, 'call', _52 => _52((item) => item.label === label.text), 'optionalAccess', _53 => _53.value])]
            })]
          })]
        }, `legend-${label.text}-${i}`);
      })
...
//# sourceMappingURL=chunk-EW6ETSNZ.cjs.map