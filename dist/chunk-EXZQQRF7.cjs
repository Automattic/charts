...
var _chunkL2OXRJUNcjs = require('./chunk-L2OXRJUN.cjs');
...
var BarChartInternal = ({
  ...
  const chartId = _chunkYDADXRCCcjs.useChartId.call(void 0, providedChartId);
  const theme = _chunkYDADXRCCcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkYDADXRCCcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkYDADXRCCcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues,
    valueAxisLength: horizontal ? width : height
  });
  const legendItems = _chunkNF7VOWAYcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkYDADXRCCcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, , svgWrapperHeight] = _chunkYDADXRCCcjs.useElementSize.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkL2OXRJUNcjs.useChartChildren.call(void 0, children, "BarChart");
  ...
  const {
    getElementStyles,
    isSeriesVisible
  } = _chunkYDADXRCCcjs.useGlobalChartsContext.call(void 0, );
  const providerTheme = _chunkYDADXRCCcjs.useGlobalChartsTheme.call(void 0, );
  ...
  _chunkYDADXRCCcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "bar",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkYDADXRCCcjs.usePrefersReducedMotion.call(void 0, );
  if (error) {
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkNF7VOWAYcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkNF7VOWAYcjs.SingleChartContext.Provider, {
    value: {
      chartId,
      chartWidth: width,
      chartHeight
    ...
    children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkREZTQ4PHcjs.Stack, {
      ...
      children: [legendPosition === "top" && legendElement, _chunkL2OXRJUNcjs.renderLegendSlot.call(void 0, legendChildren, "top"), /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
      ...
      }), legendPosition === "bottom" && legendElement, _chunkL2OXRJUNcjs.renderLegendSlot.call(void 0, legendChildren, "bottom"), nonLegendChildren]
    })
  });
};
var BarChartWithProvider = (props) => {
  const existingContext = _react.useContext.call(void 0, _chunkYDADXRCCcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, {
      ...props
    });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYDADXRCCcjs.GlobalChartsProvider, {
...
var BarChart = _chunkVTS3PNMScjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkNF7VOWAYcjs.Legend
});
...
//# sourceMappingURL=chunk-EXZQQRF7.cjs.map