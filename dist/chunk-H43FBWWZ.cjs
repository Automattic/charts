...
var BaseTooltip = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: base_tooltip_module_default.tooltip, style: { top, left }, role: "tooltip", children: children || data && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Component, { data, className }) });
};
...
//# sourceMappingURL=chunk-H43FBWWZ.cjs.map