...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkP2LIEOFQcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const theme = _chunkP2LIEOFQcjs.useGlobalChartsTheme.call(void 0, );
  const context = _react.useContext.call(void 0, _chunkP2LIEOFQcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkMXGLYWVPcjs.formatPercentage.call(void 0, point.percentage);
      case "value":
...
//# sourceMappingURL=chunk-HEVMLPZC.cjs.map