...
var getChartColor = (index, colorCache) => {
  ...
  for (let attempt = 0; attempt < MAX_COLOR_GENERATION_ATTEMPTS; attempt++) {
    ...
    for (const existingHsl of existingHslColors) {
      if (_chunkWPSB7BRRcjs.getColorDistance.call(void 0, candidateHsl, existingHsl) < MIN_COLOR_DISTANCE) {
...
var GlobalChartsProvider = ({ children, theme }) => {
  ...
  const providerTheme = _react.useMemo.call(void 0, () => {
    return theme ? _chunkWPSB7BRRcjs.mergeThemes.call(void 0, defaultTheme, theme) : defaultTheme;
  }, [theme]);
    ...
    if (Array.isArray(colors)) {
      for (const color of colors) {
        if (color && typeof color === "string") {
          ...
          if (color.startsWith("--")) {
            const resolved = _chunkWPSB7BRRcjs.resolveCssVariable.call(void 0, color, wrapperRef.current);
          ...
          if (colorValue.startsWith("#")) {
            ...
            try {
              const hslColor = _chunkWPSB7BRRcjs.hexToHsl.call(void 0, colorValue);
  ...
  const getElementStyles = _react.useCallback.call(void 0, 
    ({ data, index, overrideColor, legendShape }) => {
      ...
      return {
        ...
        lineStyles: isSeriesData ? _chunkWPSB7BRRcjs.getSeriesLineStyles.call(void 0, data, index, providerTheme) : {},
        glyph: _optionalChain([providerTheme, 'access', _5 => _5.glyphs, 'optionalAccess', _6 => _6[index]]),
        shapeStyles: isSeriesData ? _chunkWPSB7BRRcjs.getItemShapeStyles.call(void 0, data, index, providerTheme, legendShape) : {}
      };
    },
...
var useXYChartTheme = (data) => {
  ...
  return _react.useMemo.call(void 0, () => {
    const seriesColors = (_nullishCoalesce(data, () => ( []))).map((series) => _optionalChain([series, 'access', _7 => _7.options, 'optionalAccess', _8 => _8.stroke])).filter((color) => Boolean(color));
...
var useChartDataTransform = (data) => {
  return _react.useMemo.call(void 0, () => {
    const firstPoint = _optionalChain([data, 'optionalAccess', _9 => _9[0], 'optionalAccess', _10 => _10.data, 'optionalAccess', _11 => _11[0]]);
    ...
    return data.map((series) => ({
      ...
      data: series.data.map((point) => {
        ...
        if ("date" in point && point.date) {
          ...
          date = _chunkWPSB7BRRcjs.parseAsLocalDate.call(void 0, point.dateString);
        }
        return {
          ...point,
          date
  ...
  const yTicks = _react.useMemo.call(void 0, () => {
    ...
    if (horizontal) {
      return allDataPoints.map(
        (d) => d.label || _optionalChain([options, 'access', _12 => _12.axis, 'optionalAccess', _13 => _13.y, 'optionalAccess', _14 => _14.tickFormat, 'call', _15 => _15(d.date.getTime(), 0, [])])
      );
    }
    ...
    return _scale.getTicks.call(void 0, yScale, _optionalChain([options, 'access', _16 => _16.axis, 'optionalAccess', _17 => _17.y, 'optionalAccess', _18 => _18.numTicks]));
  }, [options, data, height, horizontal]);
  return _react.useMemo.call(void 0, () => {
    const defaultMargin = { top: 10, right: 20, bottom: 20, left: 20 };
    const defaultTickWidth = 40;
    const yAxisOrientation = _optionalChain([options, 'access', _19 => _19.axis, 'optionalAccess', _20 => _20.y, 'optionalAccess', _21 => _21.orientation]);
    const yAxisStyles = yAxisOrientation === "right" ? theme.axisStyles.y.right : theme.axisStyles.y.left;
    const yTickWidth = _chunkWPSB7BRRcjs.getLongestTickWidth.call(void 0, 
      yTicks,
      _optionalChain([options, 'access', _22 => _22.axis, 'optionalAccess', _23 => _23.y, 'optionalAccess', _24 => _24.tickFormat]),
      yAxisStyles.axisLabel
    );
    const yMarginValue = (_nullishCoalesce(yTickWidth, () => ( defaultTickWidth))) + (_nullishCoalesce(_optionalChain([yAxisStyles, 'optionalAccess', _25 => _25.tickLength]), () => ( 0)));
    if (yAxisOrientation === "right") {
      defaultMargin.right = yMarginValue;
    } else {
      defaultMargin.left = yMarginValue;
    }
    if (_optionalChain([options, 'access', _26 => _26.axis, 'optionalAccess', _27 => _27.x, 'optionalAccess', _28 => _28.orientation]) === "top") {
...
var useGlobalChartsTheme = () => {
  const context = _react.useContext.call(void 0, GlobalChartsContext);
  const globalTheme = _optionalChain([context, 'optionalAccess', _29 => _29.theme]);
