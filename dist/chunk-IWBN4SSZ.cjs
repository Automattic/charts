...
var PieChartInternal = ({
  ...
  const { visibleData, allSegmentsHidden, legendData } = _chunkAUKI2LYNcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunk5X6FNGNQcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
...
var PieChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAUKI2LYNcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, PieChartInternal, { ...props }) });
};
PieChartWithProvider.displayName = "PieChart";
var PieChart = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, PieChartWithProvider, {
  Legend: _chunk5X6FNGNQcjs.Legend,
  SVG: _chunk3Z526IL2cjs.ChartSVG,
  HTML: _chunk3Z526IL2cjs.ChartHTML
});
var PieChartResponsive = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-IWBN4SSZ.cjs.map