...
var _chunkQCVFZQZ2cjs = require('./chunk-QCVFZQZ2.cjs');
...
var _chunkW4WIULCLcjs = require('./chunk-W4WIULCL.cjs');
...
var BarChartInternal = ({
  ...
  const chartId = _chunkW4WIULCLcjs.useChartId.call(void 0, providedChartId);
  const theme = _chunkW4WIULCLcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkW4WIULCLcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkW4WIULCLcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkW4WIULCLcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkW4WIULCLcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, , svgWrapperHeight] = _chunkW4WIULCLcjs.useElementSize.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const hasLegendChild = _chunkW4WIULCLcjs.useHasLegendChild.call(void 0, children);
  ...
  const { getElementStyles, isSeriesVisible } = _chunkW4WIULCLcjs.useGlobalChartsContext.call(void 0, );
  const providerTheme = _chunkW4WIULCLcjs.useGlobalChartsTheme.call(void 0, );
  ...
  _chunkW4WIULCLcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "bar",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkW4WIULCLcjs.usePrefersReducedMotion.call(void 0, );
  if (error) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    _chunkW4WIULCLcjs.SingleChartContext.Provider,
    {
      value: {
        chartId,
        chartWidth: width,
                    ...
                    children: [
                      ...
                      withPatterns && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "defs", { "data-testid": "bar-chart-patterns", children: dataSorted.map(
                          (seriesData, index) => renderPattern(
                            index,
...
var BarChartWithProvider = (props) => {
  const existingContext = _react.useContext.call(void 0, _chunkW4WIULCLcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkW4WIULCLcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props }) });
};
...
var BarChart = _chunkZVGEDXDPcjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkW4WIULCLcjs.Legend
});
var BarChartResponsive = _chunkZVGEDXDPcjs.attachSubComponents.call(void 0, 
  _chunkQCVFZQZ2cjs.withResponsive.call(void 0, BarChartWithProvider),
  {
    Legend: _chunkW4WIULCLcjs.Legend
  }
);
...
//# sourceMappingURL=chunk-KF5L2AGG.cjs.map