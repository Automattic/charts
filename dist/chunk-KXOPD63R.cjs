...
var defaultValueFormatter = (value) => {
  return _chunkBS3VZTWUcjs.formatMetricValue.call(void 0, value, "number", {
    useMultipliers: true,
    decimals: 1
  });
};
var defaultDeltaFormatter = (value) => {
  return _chunkBS3VZTWUcjs.formatMetricValue.call(void 0, value / 100, "average", {
    decimals: 0,
...
var LeaderboardChartInternal = ({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkBS3VZTWUcjs.useGlobalChartsTheme.call(void 0, );
  const {
    labelSpacing,
    rowGap,
    columnGap,
  ...
  const { resolveGroupColor } = _chunkBS3VZTWUcjs.useGlobalChartsContext.call(void 0, );
...
var LeaderboardChart = (props) => {
  const existingContext = _react.useContext.call(void 0, _chunkBS3VZTWUcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LeaderboardChartInternal, { ...props });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkBS3VZTWUcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LeaderboardChartInternal, { ...props }) });
};
