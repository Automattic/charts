...
function useLeaderboardLegendItems({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkYDADXRCCcjs.useGlobalChartsTheme.call(void 0, );
  const { getElementStyles } = _chunkYDADXRCCcjs.useGlobalChartsContext.call(void 0, );
...
var LeaderboardChartInternal = ({
  ...
  } = _chunkYDADXRCCcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkL2OXRJUNcjs.useChartChildren.call(void 0, children, "LeaderboardChart");
  const {
    labelSpacing,
    rowGap,
    columnGap,
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KXVMWAF6.cjs.map