...
var PieChartInternal = ({
  ...
  const [svgWrapperRef, svgWrapperWidth, svgWrapperHeight] = _chunkYDADXRCCcjs.useElementSize.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunkYDADXRCCcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunkNF7VOWAYcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
  const {
    ...
    legendChildren,
    otherChildren
  } = _chunkL2OXRJUNcjs.useChartChildren.call(void 0, children, "PieChart");
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkNF7VOWAYcjs.SingleChartContext.Provider, {
    ...
    children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkREZTQ4PHcjs.Stack, {
      ...
      }), legendPosition === "bottom" && legendElement, _chunkL2OXRJUNcjs.renderLegendSlot.call(void 0, legendChildren, "bottom"), withTooltips && tooltipOpen && tooltipData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TooltipInPortal, {
        top: tooltipTop || 0,
        left: tooltipLeft || 0,
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
          role: "tooltip",
...
var PieChart = _chunkVTS3PNMScjs.attachSubComponents.call(void 0, PieChartWithProvider, {
  ...
  SVG: _chunkL2OXRJUNcjs.ChartSVG,
  HTML: _chunkL2OXRJUNcjs.ChartHTML
});
...
//# sourceMappingURL=chunk-L5GGOCO7.cjs.map