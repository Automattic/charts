  ...
  return _react.useMemo.call(void 0, () => {
    ...
    _react.Children.forEach(children, (child) => {
      if (_react.isValidElement.call(void 0, child)) {
        if (child.type === _chunkHEVMLPZCcjs.Legend) {
...
var ChartLayout = ({
  ...
  const [contentRef, contentWidth, contentHeight] = _chunkP2LIEOFQcjs.useElementSize.call(void 0, );
...
//# sourceMappingURL=chunk-LA3Y2O6N.cjs.map