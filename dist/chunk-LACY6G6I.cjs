...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkI7MCBD76cjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkI7MCBD76cjs.useGlobalChartsTheme.call(void 0, );
    const context = _react.useContext.call(void 0, _chunkI7MCBD76cjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkWPSB7BRRcjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
//# sourceMappingURL=chunk-LACY6G6I.cjs.map