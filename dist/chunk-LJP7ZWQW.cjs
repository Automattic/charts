...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkP6GF5KEQcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkSLF2F4AOcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkP6GF5KEQcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const defaultMargin = _chunkP6GF5KEQcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkSLF2F4AOcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
                    ...
                    _xychart.XYChart,
                    {
                      ...
                      children: [
                        ...
                        dataSorted.map((seriesData, index) => {
                          ...
                          const lineStyles = _chunkP6GF5KEQcjs.getSeriesLineStyles.call(void 0, seriesData, index, providerTheme);
                          const lineProps = {
                            stroke,
                            ...lineStyles
                          };
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkP6GF5KEQcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkP6GF5KEQcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
...
var LineChartResponsive = _chunkP6GF5KEQcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-LJP7ZWQW.cjs.map