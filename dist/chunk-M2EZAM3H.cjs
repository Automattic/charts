...
var PieChartInternal = ({
  ...
  const dataWithPercentages = _chunkP2LIEOFQcjs.useDataWithPercentages.call(void 0, data);
  const {
    visibleData,
    allSegmentsHidden,
    legendData
  } = _chunkP2LIEOFQcjs.useInteractiveLegendData.call(void 0, {
  ...
  const legendItems = _chunkHEVMLPZCcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
  const {
    ...
    legendChildren,
    otherChildren
  } = _chunkLA3Y2O6Ncjs.useChartChildren.call(void 0, children, "PieChart");
...
var PieChart = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, PieChartWithProvider, {
  ...
  SVG: _chunkLA3Y2O6Ncjs.ChartSVG,
  HTML: _chunkLA3Y2O6Ncjs.ChartHTML
});
...
//# sourceMappingURL=chunk-M2EZAM3H.cjs.map