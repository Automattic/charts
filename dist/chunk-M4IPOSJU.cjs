...
var BarChartInternal = ({
  ...
  const dataWithVisibleZeros = _chunkM4OSG2EScjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkSEPMBOVDcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkM4OSG2EScjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
...
var BarChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkM4OSG2EScjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props }) });
};
BarChartWithProvider.displayName = "BarChart";
var BarChart = _chunkM4OSG2EScjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunkSEPMBOVDcjs.Legend
});
var BarChartResponsive = _chunkM4OSG2EScjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-M4IPOSJU.cjs.map