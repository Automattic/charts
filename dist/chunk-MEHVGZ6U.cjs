...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkBJKZ4CCEcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkBJKZ4CCEcjs.useGlobalChartsTheme.call(void 0, );
    const context = _react.useContext.call(void 0, _chunkBJKZ4CCEcjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-MEHVGZ6U.cjs.map