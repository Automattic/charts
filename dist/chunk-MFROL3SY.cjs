...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const context = _react.useContext.call(void 0, _chunkBS3VZTWUcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkBS3VZTWUcjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
function processSeriesData(seriesData, theme, showValues, withGlyph, glyphSize, renderGlyph, legendShape) {
  const mapper = (series, index) => {
    const { shapeStyles } = _chunkBS3VZTWUcjs.getItemShapeStyles.call(void 0, series, index, theme, legendShape);
    const baseItem = {
      label: series.label,
      ...
      color: _chunkBS3VZTWUcjs.getSeriesStroke.call(void 0, series, index, theme.colors),
...
//# sourceMappingURL=chunk-MFROL3SY.cjs.map