...
var PieChartInternal = ({
  ...
  const [svgWrapperRef, svgWrapperWidth, svgWrapperHeight] = _chunkN3VZKO2Qcjs.useElementSize.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunkN3VZKO2Qcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunkN3VZKO2Qcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
...
//# sourceMappingURL=chunk-MVNIAGKA.cjs.map