...
import { createContext, useCallback as useCallback2, useMemo, useState, useEffect, useRef as useRef2 } from "react";
...
var GlobalChartsProvider = ({
  ...
  const groupToColorMapRef = useRef2(/* @__PURE__ */ new Map());
  useEffect(() => {
  ...
  const resolveGroupColor = useCallback2(
...
var ThemeProvider = ({ theme = {}, children }) => {
  return /* @__PURE__ */ jsx2(ThemeContext.Provider, { value: theme, children });
};
...
//# sourceMappingURL=chunk-NB3M3ZHU.js.map