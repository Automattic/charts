...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkYDADXRCCcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const context = _react.useContext.call(void 0, _chunkYDADXRCCcjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-NF7VOWAY.cjs.map