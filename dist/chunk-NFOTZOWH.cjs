...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkAUKI2LYNcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunk5X6FNGNQcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunkAUKI2LYNcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkAUKI2LYNcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkAUKI2LYNcjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkAUKI2LYNcjs.useXYChartTheme.call(void 0, data);
    const chartId = _chunkAUKI2LYNcjs.useChartId.call(void 0, providedChartId);
    const [legendRef, legendHeight] = _chunkAUKI2LYNcjs.useElementHeight.call(void 0, );
    ...
    const dataSorted = _chunkAUKI2LYNcjs.useChartDataTransform.call(void 0, data);
    ...
    const defaultMargin = _chunkAUKI2LYNcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunk5X6FNGNQcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAUKI2LYNcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
...
var LineChartResponsive = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-NFOTZOWH.cjs.map