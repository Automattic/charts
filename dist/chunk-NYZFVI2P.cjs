...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkW3H42XRVcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const context = _react.useContext.call(void 0, _chunkW3H42XRVcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkDAKYGZG6cjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
//# sourceMappingURL=chunk-NYZFVI2P.cjs.map