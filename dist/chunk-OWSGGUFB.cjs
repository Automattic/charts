...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkAZUJIXDXcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const theme = _chunkAZUJIXDXcjs.useGlobalChartsTheme.call(void 0, );
  const context = _react.useContext.call(void 0, _chunkAZUJIXDXcjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-OWSGGUFB.cjs.map