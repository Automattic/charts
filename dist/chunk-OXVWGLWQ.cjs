...
var PieChartInternal = ({
  ...
  const [svgWrapperRef, svgWrapperWidth, svgWrapperHeight] = _chunkAZUJIXDXcjs.useElementSize.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunkAZUJIXDXcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunkOWSGGUFBcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
  const {
    ...
    legendChildren,
    otherChildren
  } = _chunk2NI4JQIBcjs.useChartChildren.call(void 0, children, "PieChart");
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOWSGGUFBcjs.SingleChartContext.Provider, {
    ...
    children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkREZTQ4PHcjs.Stack, {
      ...
      }), legendPosition === "bottom" && legendElement, _chunk2NI4JQIBcjs.renderLegendSlot.call(void 0, legendChildren, "bottom"), withTooltips && tooltipOpen && tooltipData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TooltipInPortal, {
        top: tooltipTop || 0,
        left: tooltipLeft || 0,
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
          role: "tooltip",
...
var PieChart = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, PieChartWithProvider, {
  ...
  SVG: _chunk2NI4JQIBcjs.ChartSVG,
  HTML: _chunk2NI4JQIBcjs.ChartHTML
});
...
//# sourceMappingURL=chunk-OXVWGLWQ.cjs.map