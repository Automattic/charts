...
function useLeaderboardLegendItems({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkWYK7EL5Rcjs.useGlobalChartsTheme.call(void 0, );
...
var LeaderboardChartInternal = ({
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkTZRUHQOHcjs.useChartChildren.call(void 0, children, "LeaderboardChart");
  const {
    labelSpacing,
    rowGap,
    columnGap,
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OYC34VTO.cjs.map