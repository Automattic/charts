...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkOLHJTLY4cjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkOLHJTLY4cjs.useGlobalChartsTheme.call(void 0, );
    const context = _react.useContext.call(void 0, _chunkOLHJTLY4cjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-PD4ADOLW.cjs.map