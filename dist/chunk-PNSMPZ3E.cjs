...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkLSGYIUQXcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkLSGYIUQXcjs.useGlobalChartsTheme.call(void 0, );
    const context = _react.useContext.call(void 0, _chunkLSGYIUQXcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkLSGYIUQXcjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
//# sourceMappingURL=chunk-PNSMPZ3E.cjs.map