...
var PieChartInternal = ({
  ...
  const [svgWrapperRef, svgWrapperWidth, svgWrapperHeight] = _chunkZMKLYXJNcjs.useElementSize.call(void 0, );
  const {
    tooltipOpen,
    tooltipLeft,
    tooltipTop,
  ...
  const {
    ...
    allSegmentsHidden,
    legendData
  } = _chunkZMKLYXJNcjs.useInteractiveLegendData.call(void 0, {
    data,
    chartId,
    legendInteractive,
    isSeriesVisible
  ...
  const legendItems = _chunkZMKLYXJNcjs.useChartLegendItems.call(void 0, legendData, legendOptions);
  const {
    isValid,
    message
  } = validateData(data);
...
//# sourceMappingURL=chunk-QMT45PFP.cjs.map