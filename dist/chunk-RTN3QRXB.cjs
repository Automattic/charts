...
function useText(props) {
  ...
  const classes = _chunkREZTQ4PHcjs.useMemo.call(void 0, () => {
    ...
    return cx2(Text, sx.Base, sx.optimalTextColor, isDestructive && destructive, !!isHighlighter && highlighterText, isBlock && block, isCaption && muted, variant && styles_exports2[variant], upperCase2 && sx.upperCase, className);
...
function useLeaderboardLegendItems({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkP2LIEOFQcjs.useGlobalChartsTheme.call(void 0, );
  const { getElementStyles } = _chunkP2LIEOFQcjs.useGlobalChartsContext.call(void 0, );
...
var defaultValueFormatter = (value) => {
  return _chunkMXGLYWVPcjs.formatMetricValue.call(void 0, value, "number", {
    useMultipliers: true,
    decimals: 1
  });
};
var defaultDeltaFormatter = (value) => {
  return _chunkMXGLYWVPcjs.formatMetricValue.call(void 0, value / 100, "average", {
    decimals: 0,
...
var LeaderboardChartInternal = ({
  ...
  } = _chunkP2LIEOFQcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkLA3Y2O6Ncjs.useChartChildren.call(void 0, children, "LeaderboardChart");
  const {
    labelSpacing,
    rowGap,
    columnGap,
...
var LeaderboardChart = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, LeaderboardChartWithProvider, {
  Legend: _chunkHEVMLPZCcjs.Legend
});
var LeaderboardChartResponsive = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, _chunkASLARV7Lcjs.withResponsive.call(void 0, LeaderboardChartWithProvider), {
  Legend: _chunkHEVMLPZCcjs.Legend
});
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-RTN3QRXB.cjs.map