...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkBS3VZTWUcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkMFROL3SYcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunkBS3VZTWUcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkBS3VZTWUcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkBS3VZTWUcjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkBS3VZTWUcjs.useXYChartTheme.call(void 0, data);
    const chartId = _chunkBS3VZTWUcjs.useChartId.call(void 0, providedChartId);
    const [legendRef, legendHeight] = _chunkBS3VZTWUcjs.useElementHeight.call(void 0, );
    ...
    const dataSorted = _chunkBS3VZTWUcjs.useChartDataTransform.call(void 0, data);
    ...
    const tooltipRenderGlyph = _react.useMemo.call(void 0, () => {
      return (props) => {
        ...
        const resolvedColor = seriesData ? resolveGroupColor({
          group: seriesData.group,
          index: seriesIndex,
          overrideColor: _optionalChain([seriesData, 'access', _47 => _47.options, 'optionalAccess', _48 => _48.stroke])
        }) : props.color;
        const propsWithResolvedColor = { ...props, color: resolvedColor };
        const themeGlyph = _optionalChain([providerTheme, 'access', _49 => _49.glyphs, 'optionalAccess', _50 => _50[seriesIndex]]);
    ...
    const defaultMargin = _chunkBS3VZTWUcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    const error = validateData(dataSorted);
    const isDataValid = !error;
    const legendOptions = _react.useMemo.call(void 0, 
      () => ({
        withGlyph: withLegendGlyph,
        glyphSize: Math.max(0, _nullishCoalesce(toNumber(_optionalChain([glyphStyle, 'optionalAccess', _51 => _51.radius])), () => ( 4))),
        renderGlyph
      }),
      [withLegendGlyph, _optionalChain([glyphStyle, 'optionalAccess', _52 => _52.radius]), renderGlyph]
    );
    const legendItems = _chunkMFROL3SYcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
    ...
    _chunkBS3VZTWUcjs.useChartRegistration.call(void 0, {
      chartId,
      legendItems,
      chartType: "line",
      isDataValid,
    ...
    const accessors = {
      xAccessor: (d) => _optionalChain([d, 'optionalAccess', _53 => _53.date]),
      yAccessor: (d) => _optionalChain([d, 'optionalAccess', _54 => _54.value])
    };
    if (error) {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      _chunkMFROL3SYcjs.SingleChartContext.Provider,
      {
        value: {
          chartId,
                      ...
                      children: [
                        ...
                        dataSorted.map((seriesData, index) => {
                          const stroke = resolveGroupColor({
                            group: seriesData.group,
                            index,
                            overrideColor: _optionalChain([seriesData, 'access', _55 => _55.options, 'optionalAccess', _56 => _56.stroke])
                          });
                          const lineStyles = _chunkBS3VZTWUcjs.getSeriesLineStyles.call(void 0, seriesData, index, providerTheme);
                          const lineProps = {
                            stroke,
                            ...lineStyles
                          };
                          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { children: [
                            withStartGlyphs && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              StartGlyph,
                              {
                                ...
                                data: seriesData,
                                color: stroke,
                                renderGlyph: _nullishCoalesce(_optionalChain([providerTheme, 'access', _57 => _57.glyphs, 'optionalAccess', _58 => _58[index]]), () => ( renderGlyph)),
                                accessors,
                                glyphStyle
                              }
                            ),
                            withGradientFill && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              _gradient.LinearGradient,
                              {
                                ...
                                ..._optionalChain([seriesData, 'access', _59 => _59.options, 'optionalAccess', _60 => _60.gradient]),
                            ...
                            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              _xychart.AreaSeries,
                              {
                                dataKey: _optionalChain([seriesData, 'optionalAccess', _61 => _61.label]),
                              ...
                              _optionalChain([seriesData, 'optionalAccess', _62 => _62.label])
                            )
                          ] }, _optionalChain([seriesData, 'optionalAccess', _63 => _63.label]) || index);
                        }),
                        withTooltips && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                          _chunkH43FBWWZcjs.AccessibleTooltip,
                          {
                            ...
                            glyphStyle,
                            showVerticalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _64 => _64.showVertical]),
                            showHorizontalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _65 => _65.showHorizontal]),
                            selectedIndex,
                            tooltipRef,
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkBS3VZTWUcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkBS3VZTWUcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
  Legend: _chunkMFROL3SYcjs.Legend,
  AnnotationsOverlay: line_chart_annotations_overlay_default,
  Annotation: line_chart_annotation_default
});
var LineChartResponsive = _chunkBS3VZTWUcjs.attachSubComponents.call(void 0, 
...
exports.LineChartResponsive = LineChartResponsive;
//# sourceMappingURL=chunk-RXE5VSSC.cjs.map