...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkYNBUU2YKcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const theme = _chunkYNBUU2YKcjs.useGlobalChartsTheme.call(void 0, );
...
var Legend = _react.forwardRef.call(void 0, 
  ({ chartId, items, ...props }, ref) => {
    const context = _react.useContext.call(void 0, _chunkYNBUU2YKcjs.GlobalChartsContext);
...
function formatPointValue(point, showValues, legendValueDisplay = "percentage") {
  ...
  if ("percentage" in point) {
    ...
    switch (legendValueDisplay) {
      case "percentage":
        return _chunkYNBUU2YKcjs.formatPercentage.call(void 0, percentagePoint.percentage);
      case "value":
...
//# sourceMappingURL=chunk-SGYJXUSH.cjs.map