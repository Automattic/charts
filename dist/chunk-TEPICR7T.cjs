...
var BarChartInternal = ({
  ...
  const theme = _chunkAZUJIXDXcjs.useXYChartTheme.call(void 0, data);
  const dataSorted = _chunkAZUJIXDXcjs.useChartDataTransform.call(void 0, data);
  const dataWithVisibleZeros = _chunkAZUJIXDXcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues,
    valueAxisLength: horizontal ? width : height
  });
  const legendItems = _chunkOWSGGUFBcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkAZUJIXDXcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
  const [svgWrapperRef, , svgWrapperHeight] = _chunkAZUJIXDXcjs.useElementSize.call(void 0, );
  const chartRef = _react.useRef.call(void 0, null);
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkTZDU3FURcjs.useChartChildren.call(void 0, children, "BarChart");
  ...
  const providerTheme = _chunkAZUJIXDXcjs.useGlobalChartsTheme.call(void 0, );
...
//# sourceMappingURL=chunk-TEPICR7T.cjs.map