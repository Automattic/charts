...
var _chunkSGYJXUSHcjs = require('./chunk-SGYJXUSH.cjs');
...
var _chunkYNBUU2YKcjs = require('./chunk-YNBUU2YK.cjs');
...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunkYNBUU2YKcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkSGYJXUSHcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunkYNBUU2YKcjs.useGlobalChartsTheme.call(void 0, );
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunkYNBUU2YKcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const providerTheme = _chunkYNBUU2YKcjs.useGlobalChartsTheme.call(void 0, );
    const theme = _chunkYNBUU2YKcjs.useXYChartTheme.call(void 0, data);
    const chartId = _chunkYNBUU2YKcjs.useChartId.call(void 0, providedChartId);
    const [legendRef, legendHeight] = _chunkYNBUU2YKcjs.useElementHeight.call(void 0, );
    ...
    const dataSorted = _chunkYNBUU2YKcjs.useChartDataTransform.call(void 0, data);
    const { getElementStyles } = _chunkYNBUU2YKcjs.useGlobalChartsContext.call(void 0, );
      ...
      return {
        axis: {
          x: {
            ...
            ..._optionalChain([options, 'optionalAccess', _49 => _49.axis, 'optionalAccess', _50 => _50.x])
          },
          y: {
            orientation: "left",
            numTicks: 4,
            tickFormat: _numberformatters.formatNumberCompact,
            ..._optionalChain([options, 'optionalAccess', _51 => _51.axis, 'optionalAccess', _52 => _52.y])
          }
        },
        xScale: {
          type: "time",
          ..._optionalChain([options, 'optionalAccess', _53 => _53.xScale])
        },
        yScale: {
          type: "linear",
          nice: true,
          zero: false,
          ..._optionalChain([options, 'optionalAccess', _54 => _54.yScale])
        }
      };
    ...
    const defaultMargin = _chunkYNBUU2YKcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    const error = validateData(dataSorted);
    const isDataValid = !error;
    const legendOptions = _react.useMemo.call(void 0, 
      () => ({
        withGlyph: withLegendGlyph,
        glyphSize: Math.max(0, _nullishCoalesce(toNumber2(_optionalChain([glyphStyle, 'optionalAccess', _55 => _55.radius])), () => ( 4))),
        renderGlyph
      }),
      [withLegendGlyph, _optionalChain([glyphStyle, 'optionalAccess', _56 => _56.radius]), renderGlyph]
    );
    const legendItems = _chunkSGYJXUSHcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
    ...
    _chunkYNBUU2YKcjs.useChartRegistration.call(void 0, {
      chartId,
      legendItems,
      chartType: "line",
      isDataValid,
    ...
    const accessors = {
      xAccessor: (d) => _optionalChain([d, 'optionalAccess', _57 => _57.date]),
      yAccessor: (d) => _optionalChain([d, 'optionalAccess', _58 => _58.value])
    };
    if (error) {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      _chunkSGYJXUSHcjs.SingleChartContext.Provider,
      {
        value: {
          chartId,
                    ...
                    _xychart.XYChart,
                    {
                      ...
                      children: [
                        ...
                        dataSorted.map((seriesData, index) => {
                          ...
                          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { children: [
                            withGradientFill && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              _gradient.LinearGradient,
                              {
                                ...
                                children: _optionalChain([seriesData, 'access', _61 => _61.options, 'optionalAccess', _62 => _62.gradient, 'optionalAccess', _63 => _63.stops, 'optionalAccess', _64 => _64.map, 'call', _65 => _65((stop, stopIndex) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                                  "stop",
                                  {
                                    offset: stop.offset,
                            ...
                            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              _xychart.AreaSeries,
                              {
                                dataKey: _optionalChain([seriesData, 'optionalAccess', _66 => _66.label]),
                              ...
                              _optionalChain([seriesData, 'optionalAccess', _67 => _67.label])
                            ),
                          ...
                          ] }, _optionalChain([seriesData, 'optionalAccess', _68 => _68.label]) || index);
                        }),
                        withTooltips && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                          _chunk6GO5PFYLcjs.AccessibleTooltip,
                          {
                            ...
                            glyphStyle,
                            showVerticalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _69 => _69.showVertical]),
                            showHorizontalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _70 => _70.showHorizontal]),
                            selectedIndex,
                            tooltipRef,
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  const existingContext = _react.useContext.call(void 0, _chunkYNBUU2YKcjs.GlobalChartsContext);
  if (existingContext) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref });
  }
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYNBUU2YKcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunkYNBUU2YKcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
  Legend: _chunkSGYJXUSHcjs.Legend,
  AnnotationsOverlay: line_chart_annotations_overlay_default,
  Annotation: line_chart_annotation_default
});
var LineChartResponsive = _chunkYNBUU2YKcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-U7CFRAZ5.cjs.map