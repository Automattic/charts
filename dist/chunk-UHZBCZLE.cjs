...
var BarChartInternal = ({
  ...
  const dataWithVisibleZeros = _chunkAUKI2LYNcjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunk5X6FNGNQcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkAUKI2LYNcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
...
var BarChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAUKI2LYNcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props }) });
};
BarChartWithProvider.displayName = "BarChart";
var BarChart = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, BarChartWithProvider, {
  Legend: _chunk5X6FNGNQcjs.Legend
});
var BarChartResponsive = _chunkAUKI2LYNcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-UHZBCZLE.cjs.map