...
var LineChartAnnotationsOverlay = ({
  ...
  const {
    ...
    chartWidth,
    chartHeight
  } = _chunkOWSGGUFBcjs.useSingleChartContext.call(void 0, );
...
var LineChartInternal = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkTZDU3FURcjs.useChartChildren.call(void 0, children, "LineChart");
  ...
  const defaultMargin = _chunkAZUJIXDXcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
  ...
  const legendItems = _chunkOWSGGUFBcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
//# sourceMappingURL=chunk-V57FBUNQ.cjs.map