...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkW4WIULCLcjs.useSingleChartContext.call(void 0, );
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const defaultMargin = _chunkW4WIULCLcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkW4WIULCLcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkW4WIULCLcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
...
var LineChartResponsive = _chunkZVGEDXDPcjs.attachSubComponents.call(void 0, 
  _chunkQCVFZQZ2cjs.withResponsive.call(void 0, LineChartWithProvider),
  {
    Legend: _chunkW4WIULCLcjs.Legend,
    AnnotationsOverlay: line_chart_annotations_overlay_default,
    Annotation: line_chart_annotation_default
...
//# sourceMappingURL=chunk-VCW6ID43.cjs.map