...
var getChartColor = (index, colorCache) => {
  ...
  for (let attempt = 0; attempt < MAX_COLOR_GENERATION_ATTEMPTS; attempt++) {
    ...
    for (const existingHsl of existingHslColors) {
      if (_chunkDAKYGZG6cjs.getColorDistance.call(void 0, candidateHsl, existingHsl) < MIN_COLOR_DISTANCE) {
...
var GlobalChartsProvider = ({ children, theme }) => {
  ...
  const providerTheme = _react.useMemo.call(void 0, () => {
    return theme ? _chunkDAKYGZG6cjs.mergeThemes.call(void 0, defaultTheme, theme) : defaultTheme;
  }, [theme]);
      ...
      for (const color of colors) {
        if (color && typeof color === "string") {
          ...
          if (color.startsWith("--") || color.startsWith("var(")) {
            const resolved = _chunkDAKYGZG6cjs.resolveCssVariable.call(void 0, color, wrapperRef.current);
  ...
  const resolveColor = _react.useCallback.call(void 0, 
    ({
      ...
      if (overrideColor) {
        return _chunkDAKYGZG6cjs.normalizeColorToHex.call(void 0, overrideColor, wrapperRef.current, _chunkDAKYGZG6cjs.resolveCssVariable);
      }
      if (group) {
  ...
  const getElementStyles = _react.useCallback.call(void 0, 
    ({ data, index, overrideColor, legendShape }) => {
      ...
      return {
        ...
        lineStyles: isSeriesData ? _chunkDAKYGZG6cjs.getSeriesLineStyles.call(void 0, data, index, providerTheme) : {},
        glyph: _optionalChain([providerTheme, 'access', _5 => _5.glyphs, 'optionalAccess', _6 => _6[index]]),
        shapeStyles: isSeriesData ? _chunkDAKYGZG6cjs.getItemShapeStyles.call(void 0, data, index, providerTheme, legendShape) : {}
      };
    },
    ...
    return data.map((series) => ({
      ...
      data: series.data.map((point) => {
        ...
        if ("date" in point && point.date) {
          ...
          date = _chunkDAKYGZG6cjs.parseAsLocalDate.call(void 0, point.dateString);
        }
        return {
          ...point,
          date
...
var useChartMargin = (height, options, data, theme, horizontal = false) => {
  ...
  return _react.useMemo.call(void 0, () => {
    ...
    const yTickWidth = _chunkDAKYGZG6cjs.getLongestTickWidth.call(void 0, 
      yTicks,
...
//# sourceMappingURL=chunk-W3H42XRV.cjs.map