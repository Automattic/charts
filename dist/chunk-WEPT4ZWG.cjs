...
var _chunkLA3Y2O6Ncjs = require('./chunk-LA3Y2O6N.cjs');





var _chunkHEVMLPZCcjs = require('./chunk-HEVMLPZC.cjs');
...
var _chunkP2LIEOFQcjs = require('./chunk-P2LIEOFQ.cjs');
...
var LineChartAnnotationsOverlay = ({
  ...
  const {
    ...
    chartWidth,
    chartHeight
  } = _chunkHEVMLPZCcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const providerTheme = _chunkP2LIEOFQcjs.useGlobalChartsTheme.call(void 0, );
  const {
    xScale,
    yScale
  } = _react.useContext.call(void 0, _xychart.DataContext) || {};
...
var LineChartInternal = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const providerTheme = _chunkP2LIEOFQcjs.useGlobalChartsTheme.call(void 0, );
  const theme = _chunkP2LIEOFQcjs.useXYChartTheme.call(void 0, data);
  const chartId = _chunkP2LIEOFQcjs.useChartId.call(void 0, providedChartId);
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkLA3Y2O6Ncjs.useChartChildren.call(void 0, children, "LineChart");
  ...
  const dataSorted = _chunkP2LIEOFQcjs.useChartDataTransform.call(void 0, data);
  const {
    getElementStyles,
    isSeriesVisible
  } = _chunkP2LIEOFQcjs.useGlobalChartsContext.call(void 0, );
  ...
  const defaultMargin = _chunkP2LIEOFQcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
  ...
  const legendItems = _chunkHEVMLPZCcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
  ...
  _chunkP2LIEOFQcjs.useChartRegistration.call(void 0, {
    chartId,
    legendItems,
    chartType: "line",
    isDataValid,
  ...
  const prefersReducedMotion = _chunkP2LIEOFQcjs.usePrefersReducedMotion.call(void 0, );
  const accessors = {
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkHEVMLPZCcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkHEVMLPZCcjs.SingleChartContext.Provider, {
    value: {
      chartId,
    ...
    children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkLA3Y2O6Ncjs.ChartLayout, {
      legendPosition,
      legendElement,
      legendChildren,
      gap,
              ...
              children: [gridVisibility !== "none" && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _xychart.Grid, {
                ...
                return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", {
                  children: [withGradientFill && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _gradient.LinearGradient, {
                    ...
                    ..._optionalChain([seriesData, 'access', _70 => _70.options, 'optionalAccess', _71 => _71.gradient]),
                    children: _optionalChain([seriesData, 'access', _72 => _72.options, 'optionalAccess', _73 => _73.gradient, 'optionalAccess', _74 => _74.stops, 'optionalAccess', _75 => _75.map, 'call', _76 => _76((stop, stopIndex) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "stop", {
                      offset: stop.offset,
                      stopColor: stop.color || color,
                      stopOpacity: _nullishCoalesce(stop.opacity, () => ( 1))
                    }, `${stop.offset}-${stop.color || color}`))])
                  }), /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _xychart.AreaSeries, {
                    dataKey: _optionalChain([seriesData, 'optionalAccess', _77 => _77.label]),
                    ...
                    lineProps
                  }, _optionalChain([seriesData, 'optionalAccess', _78 => _78.label])), withStartGlyphs && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, line_chart_glyph_default, {
                    index,
                    data: seriesData,
                    color,
                ...
                }, _optionalChain([seriesData, 'optionalAccess', _79 => _79.label]) || index);
                ...
                glyphStyle,
                showVerticalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _80 => _80.showVertical]),
                showHorizontalCrosshair: _optionalChain([withTooltipCrosshairs, 'optionalAccess', _81 => _81.showHorizontal]),
                selectedIndex,
                tooltipRef,
...
var LineChartWithProvider = /* @__PURE__ */ _react.forwardRef.call(void 0, (props, ref) => {
  const existingContext = _react.useContext.call(void 0, _chunkP2LIEOFQcjs.GlobalChartsContext);
  if (existingContext) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkP2LIEOFQcjs.GlobalChartsProvider, {
...
var LineChart = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
  Legend: _chunkHEVMLPZCcjs.Legend,
...
//# sourceMappingURL=chunk-WEPT4ZWG.cjs.map