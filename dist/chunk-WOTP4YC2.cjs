...
var _chunkTZDU3FURcjs = require('./chunk-TZDU3FUR.cjs');
...
function useLeaderboardLegendItems({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkAZUJIXDXcjs.useGlobalChartsTheme.call(void 0, );
  const { getElementStyles } = _chunkAZUJIXDXcjs.useGlobalChartsContext.call(void 0, );
...
var LeaderboardChartInternal = ({
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkTZDU3FURcjs.useChartChildren.call(void 0, children, "LeaderboardChart");
  const {
    labelSpacing,
    rowGap,
    columnGap,
  ...
  if (!data || data.length === 0) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOWSGGUFBcjs.SingleChartContext.Provider, {
      value: {
        chartId,
        chartWidth: 0,
  ...
  const legendElement = showLegend && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOWSGGUFBcjs.Legend, {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOWSGGUFBcjs.SingleChartContext.Provider, {
    ...
    children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkREZTQ4PHcjs.Stack, {
      ...
      children: [legendPosition === "top" && legendElement, _chunkTZDU3FURcjs.renderLegendSlot.call(void 0, legendChildren, "top"), /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
      ...
      }), legendPosition === "bottom" && legendElement, _chunkTZDU3FURcjs.renderLegendSlot.call(void 0, legendChildren, "bottom"), nonLegendChildren]
    })
  });
};
...
var LeaderboardChart = _chunkMXGLYWVPcjs.attachSubComponents.call(void 0, LeaderboardChartWithProvider, {
  Legend: _chunkOWSGGUFBcjs.Legend
});
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-WOTP4YC2.cjs.map