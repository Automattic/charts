...
var BarChartInternal = ({
  ...
  const dataWithVisibleZeros = _chunkOLHJTLY4cjs.useZeroValueDisplay.call(void 0, dataSorted, {
    enabled: showZeroValues
  });
  const legendItems = _chunkPD4ADOLWcjs.useChartLegendItems.call(void 0, dataSorted);
  const chartOptions = useBarChartOptions(dataWithVisibleZeros, horizontal, options);
  const defaultMargin = _chunkOLHJTLY4cjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme, horizontal);
...
var BarChartWithProvider = (props) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOLHJTLY4cjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BarChartInternal, { ...props }) });
};
...
//# sourceMappingURL=chunk-WVAZ3C2Y.cjs.map