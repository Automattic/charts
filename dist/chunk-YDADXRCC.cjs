...
var useChartMargin = (height, options, data, theme, horizontal = false) => {
  ...
  return _react.useMemo.call(void 0, () => {
    ...
    const yTickWidth = _chunkVTS3PNMScjs.getLongestTickWidth.call(void 0, yTicks, _optionalChain([options, 'access', _38 => _38.axis, 'optionalAccess', _39 => _39.y, 'optionalAccess', _40 => _40.tickFormat]), yAxisStyles.axisLabel);
...
//# sourceMappingURL=chunk-YDADXRCC.cjs.map