...
var useXYChartTheme = (data) => {
  ...
  return _react.useMemo.call(void 0, () => {
    const seriesColors = (_nullishCoalesce(data, () => ( []))).map((series) => _optionalChain([series, 'access', _16 => _16.options, 'optionalAccess', _17 => _17.stroke])).filter((color) => Boolean(color));
...
var useChartDataTransform = (data) => {
  return _react.useMemo.call(void 0, () => {
    const firstPoint = _optionalChain([data, 'optionalAccess', _18 => _18[0], 'optionalAccess', _19 => _19.data, 'optionalAccess', _20 => _20[0]]);
  ...
  const yTicks = _react.useMemo.call(void 0, () => {
    ...
    if (horizontal) {
      return allDataPoints.map(
        (d) => d.label || _optionalChain([options, 'access', _21 => _21.axis, 'optionalAccess', _22 => _22.y, 'optionalAccess', _23 => _23.tickFormat, 'call', _24 => _24(d.date.getTime(), 0, [])])
      );
    }
    ...
    return _scale.getTicks.call(void 0, yScale, _optionalChain([options, 'access', _25 => _25.axis, 'optionalAccess', _26 => _26.y, 'optionalAccess', _27 => _27.numTicks]));
  }, [options, data, height, horizontal]);
  return _react.useMemo.call(void 0, () => {
    const defaultMargin = { top: 10, right: 20, bottom: 20, left: 20 };
    const defaultTickWidth = 40;
    const yAxisOrientation = _optionalChain([options, 'access', _28 => _28.axis, 'optionalAccess', _29 => _29.y, 'optionalAccess', _30 => _30.orientation]);
    ...
    const yTickWidth = getLongestTickWidth(
      yTicks,
      _optionalChain([options, 'access', _31 => _31.axis, 'optionalAccess', _32 => _32.y, 'optionalAccess', _33 => _33.tickFormat]),
      yAxisStyles.axisLabel
    );
    const yMarginValue = (_nullishCoalesce(yTickWidth, () => ( defaultTickWidth))) + (_nullishCoalesce(_optionalChain([yAxisStyles, 'optionalAccess', _34 => _34.tickLength]), () => ( 0)));
    if (yAxisOrientation === "right") {
      defaultMargin.right = yMarginValue;
    } else {
      defaultMargin.left = yMarginValue;
    }
    if (_optionalChain([options, 'access', _35 => _35.axis, 'optionalAccess', _36 => _36.x, 'optionalAccess', _37 => _37.orientation]) === "top") {
...
var useGlobalChartsTheme = () => {
  const context = _react.useContext.call(void 0, GlobalChartsContext);
  const globalTheme = _optionalChain([context, 'optionalAccess', _38 => _38.theme]);
...
//# sourceMappingURL=chunk-YMPBXVE6.cjs.map