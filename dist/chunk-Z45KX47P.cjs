...
function useLeaderboardLegendItems({
  ...
  const { leaderboardChart: leaderboardChartSettings } = _chunkRHHVEJHJcjs.useGlobalChartsTheme.call(void 0, );
  const { getElementStyles } = _chunkRHHVEJHJcjs.useGlobalChartsContext.call(void 0, );
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-Z45KX47P.cjs.map