...
var LineChartAnnotationsOverlay = ({
  ...
  const {
    ...
    chartWidth,
    chartHeight
  } = _chunkNF7VOWAYcjs.useSingleChartContext.call(void 0, );
...
var LineChartInternal = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const {
    legendChildren,
    nonLegendChildren
  } = _chunkL2OXRJUNcjs.useChartChildren.call(void 0, children, "LineChart");
  ...
  const defaultMargin = _chunkYDADXRCCcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
  ...
  const legendItems = _chunkNF7VOWAYcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
...
//# sourceMappingURL=chunk-ZEM7MCD6.cjs.map