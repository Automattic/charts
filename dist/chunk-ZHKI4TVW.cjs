...
var LineChartAnnotationLabelWithPopover = ({
  ...
  const isBrowserSafari = _chunk2HUX2CATcjs.isSafari.call(void 0, );
...
var LineChartAnnotationsOverlay = ({ children }) => {
  const { chartRef, chartWidth, chartHeight } = _chunkGK3XEXVIcjs.useSingleChartContext.call(void 0, );
...
var LineChartAnnotation = ({
  ...
  const getSafariHTMLLabelPosition = () => {
    ...
    return _chunk2HUX2CATcjs.isSafari.call(void 0, ) ? {
...
var LineChartInternal = _react.forwardRef.call(void 0, 
  ({
    ...
    const visibleData = _react.useMemo.call(void 0, () => {
      ...
      return dataSorted.map((series, index) => ({ series, originalIndex: index })).filter(({ series }) => isSeriesVisible(chartId, series.label));
    ...
    const defaultMargin = _chunk2HUX2CATcjs.useChartMargin.call(void 0, height, chartOptions, dataSorted, theme);
    ...
    const legendItems = _chunkGK3XEXVIcjs.useChartLegendItems.call(void 0, dataSorted, legendOptions, legendShape);
                    ...
                    _xychart.XYChart,
                    {
                      ...
                      children: [
                        ...
                        visibleData.map(({ series: seriesData, originalIndex }) => {
                          ...
                          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { children: [
                            ...
                            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                              _xychart.AreaSeries,
                              {
                                ...
                                ...accessors,
                                fill: withGradientFill ? `url(#area-gradient-${chartId}-${originalIndex + 1})` : "transparent",
                                renderLine: true,
                          ...
                          ] }, _optionalChain([seriesData, 'optionalAccess', _76 => _76.label]) || originalIndex);
                        }),
...
var LineChartWithProvider = _react.forwardRef.call(void 0, (props, ref) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk2HUX2CATcjs.GlobalChartsProvider, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LineChartInternal, { ...props, ref }) });
});
LineChartWithProvider.displayName = "LineChart";
var LineChart = _chunk2HUX2CATcjs.attachSubComponents.call(void 0, LineChartWithProvider, {
...
var LineChartResponsive = _chunk2HUX2CATcjs.attachSubComponents.call(void 0, 
...
//# sourceMappingURL=chunk-ZHKI4TVW.cjs.map