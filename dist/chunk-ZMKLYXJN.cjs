        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _legend.LegendItem, {
          ...
          children: [_optionalChain([items, 'access', _50 => _50[i], 'optionalAccess', _51 => _51.renderGlyph]) ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "svg", {
            ...
            children: [/* @__PURE__ */ _jsxruntime.jsx.call(void 0, LegendText, {
              ...
              textOverflow,
              maxWidth
            }), _optionalChain([items, 'access', _67 => _67.find, 'call', _68 => _68((item) => item.label === label.text), 'optionalAccess', _69 => _69.value]) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", {
              className: base_legend_module_default["legend-item-value"],
              children: ["\xA0", _optionalChain([items, 'access', _70 => _70.find, 'call', _71 => _71((item) => item.label === label.text), 'optionalAccess', _72 => _72.value])]
            })]
          })]
        }, `legend-${label.text}-${i}`);
      })
...
var Legend = /* @__PURE__ */ _react.forwardRef.call(void 0, ({
  ...
  const contextChartId = _nullishCoalesce(chartId, () => ( _optionalChain([singleChartContext, 'optionalAccess', _73 => _73.chartId])));
  const contextItems = _react.useMemo.call(void 0, () => {
    return contextChartId && context ? _optionalChain([context, 'access', _74 => _74.getChartData, 'call', _75 => _75(contextChartId), 'optionalAccess', _76 => _76.legendItems]) : void 0;
...
function processSeriesData(seriesData, getElementStyles, showValues, withGlyph, glyphSize, renderGlyph, legendShape) {
  const mapper = (series, index) => {
    ...
    const baseItem = {
      label: series.label,
      value: showValues ? _optionalChain([series, 'access', _77 => _77.data, 'optionalAccess', _78 => _78.length, 'optionalAccess', _79 => _79.toString, 'call', _80 => _80()]) || "0" : "",
      color,
...
//# sourceMappingURL=chunk-ZMKLYXJN.cjs.map