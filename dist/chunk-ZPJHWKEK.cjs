...
var LegendText = ({
  ...
  const [textRef, isTruncated] = _chunkWKN6C4ZEcjs.useTextTruncation.call(void 0, Boolean(isEllipsis));
...
var BaseLegend = _react.forwardRef.call(void 0, 
  ({
    ...
    const context = _react.useContext.call(void 0, _chunkWKN6C4ZEcjs.GlobalChartsContext);
...
//# sourceMappingURL=chunk-ZPJHWKEK.cjs.map