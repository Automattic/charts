...
let _visx_vendor_d3_array = require("@visx/vendor/d3-array");
...
*/
const defaultTheme = {
	gridStyles: { strokeWidth: 1 },
	tickLength: 4,
	xTickLineStyles: { strokeWidth: 1 },
	xAxisLineStyles: { strokeWidth: 1 },
	legend: {
		labelStyles: {},
		containerStyles: {},
		shapeStyles: []
	...
	seriesLineStyles: [],
	glyphs: [],
	svgLabelSmall: { fontFamily: "inherit" },
	svgLabelBig: { fontFamily: "inherit" },
	annotationStyles: {},
	leaderboardChart: { labelSpacing: "xs" },
...
const GlobalChartsProvider = ({ children, theme, locale, timeZone }) => {
	...
	const formatting = (0, react.useMemo)(() => sanitizeFormatting({
		locale,
		timeZone
	}), [locale, timeZone]);
	...
	return (0, react.useMemo)(() => {
		...
		return (0, _visx_xychart.buildChartTheme)({
			...
			xAxisLineStyles: {
				...
				stroke: CATALOG_POINTERS.axisX
			},
			xTickLineStyles: {
				...theme.xTickLineStyles,
				stroke: CATALOG_POINTERS.tickX
			},
...
const useChartMargin = (height, options, data, theme, horizontal = false) => {
	const yTicks = (0, react.useMemo)(() => {
		...
		const values = allDataPoints.map((d) => d.value).filter((value) => typeof value === "number" && Number.isFinite(value));
...
const BoundedTooltip = ({ left = 0, top = 0, offsetLeft = DEFAULT_OFFSET, offsetTop = DEFAULT_OFFSET, style = _visx_tooltip.defaultStyles, unstyled = false, children, placement = "auto", ...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_visx_tooltip.Tooltip, {
		...
		...rest,
		children: [placement === "below-axis" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			"aria-hidden": "true",
			style: {
				position: "absolute",
...
*/
const formatReading = (value) => value == null ? (0, _wordpress_i18n.__)("No data", "jetpack-charts") : (0, _automattic_number_formatters.formatNumber)(value);
//#endregion
...
const LineChartAnnotation = ({ datum, title, subtitle, subjectType = "circle", styles: datumStyles, testId, renderLabel, renderLabelPopover }) => {
	...
	const styles = (0, react.useMemo)(() => deepmerge.default.all([
		ANNOTATION_POINTERS,
...
function nearestByX(data, xAccessor, xScale, x) {
	return (typeof xScale.invert === "function" ? [(0, _visx_vendor_d3_array.bisector)(xAccessor).left(data, xScale.invert(x))].flatMap((index) => [index - 1, index]) : data.map((_datum, index) => index)).filter((index) => index >= 0 && index < data.length).reduce((best, index) => {
...
function NearestPointerEvents({ onPointerDown, onPointerMove, onPointerUp }) {
	const { xScale, yScale, dataRegistry } = (0, react.useContext)(_visx_xychart.DataContext);
	const findNearest = (0, react.useCallback)((params) => {
	...
	(0, _visx_xychart.useEventEmitter)("pointerdown", handlers.pointerdown);
	(0, _visx_xychart.useEventEmitter)("pointermove", handlers.pointermove);
	(0, _visx_xychart.useEventEmitter)("pointerup", handlers.pointerup);
	return null;
}
//#endregion
...
const validateData$4 = (data) => {
	...
	if (data.some((series) => series.data.some((point) => isInvalidReading(point.value, { allowMissing: true }) || "date" in point && point.date && isNaN(point.date.getTime())))) return (0, _wordpress_i18n.__)("Invalid data", "jetpack-charts");
	return null;
};
...
const LineChartInternal = (0, react.forwardRef)(({ data, chartId: providedChartId, width, height, className, margin, withTooltips = true, withTooltipCrosshairs, showLegend = false, legend = {}, renderGlyph = defaultRenderGlyph, glyphStyle = {}, withLegendGlyph = false, withGradientFill = false, smoothing = true, curveType, renderTooltip = renderDefaultTooltip, tooltipPlacement, tooltipStyle, withStartGlyphs = false, withEndGlyphs = false, animation, options = {}, onPointerDown = void 0, onPointerUp = void 0, onPointerMove = void 0, onPointerOut = void 0, onDatumActivate = void 0, zoomable = false, rescaleYOnVisibilityChange = true, defaultHiddenSeries, children, gridVisibility, gap = "md" }, ref) => {
	...
	const yDomain = (0, react.useMemo)(() => {
		const includeZero = options?.yScale?.zero === true && (0, _visx_scale.scaleCanBeZeroed)({ type: options.yScale.type ?? "linear" });
	...
	const visibleReadingExtent = (0, react.useMemo)(() => {
		let min = Infinity;
		let max = -Infinity;
		for (const series of dataSorted) {
...
const validateData$3 = (data) => {
	...
	if (data.some((series) => series.data.some((point) => isInvalidReading(point.value, { allowMissing: false }) || "date" in point && point.date && isNaN(point.date.getTime())))) return (0, _wordpress_i18n.__)("Invalid data", "jetpack-charts");
	return null;
};
//#endregion
...
const AreaChartInternal = (0, react.forwardRef)(({ data, chartId: providedChartId, width, height, className, margin, withTooltips = true, withTooltipCrosshairs, showLegend = false, legend = {}, stacked = true, stackOffset = "none", smoothing = true, curveType, fillOpacity, withStroke, renderTooltip = renderDefaultTooltip, animation, options = {}, onPointerDown, onPointerUp, onPointerMove, onPointerOut, zoomable = false, rescaleYOnVisibilityChange = true, defaultHiddenSeries, children, gridVisibility, gap = "md" }, ref) => {
	...
	const fixedYDomain = (0, react.useMemo)(() => {
		if (rescaleYOnVisibilityChange || !dataSorted.length || !dataSorted[0].data.length || stacked && stackOffset !== "none") return;
		if (stacked) {
...
*/
const getBarValue = (point) => {
	const enhanced = point;
	return (enhanced?.visualValue !== void 0 ? enhanced.visualValue : point?.value) ?? NaN;
};
/**
...
*/
const isBarRendered = (point) => Number.isFinite(getBarValue(point));
/**
...
*/
const countRenderedBars = (points) => points.filter(isBarRendered).length;
/**
...
const getValueScaleDomain = (data, hasComparisonSeries, isSeriesRendered) => {
	...
	for (const series of data) {
		if (!isSeriesRendered(series)) continue;
		for (const point of series.data) {
...
const getTooltipFormatter = (data, tickResolution, formatting) => {
	if (tickResolution === "week") {
		...
		return (timestamp) => (0, _wordpress_i18n.sprintf)((0, _wordpress_i18n.__)("Week of %s", "jetpack-charts"), formatDay(timestamp));
	}
...
*/
const createGroupScale = (keys, bandwidth, padding) => (0, _visx_scale.scaleBand)({
	domain: keys,
	range: [0, bandwidth],
	padding
});
...
function BandHighlight({ visible, horizontal, onChange }) {
	const { xScale, yScale, dataRegistry, margin, innerWidth, innerHeight } = (0, react.useContext)(_visx_xychart.DataContext);
	const { tooltipOpen, tooltipData } = (0, react.useContext)(_visx_xychart.TooltipContext);
	...
	(0, react.useEffect)(() => () => onChangeRef.current?.(null), []);
...
function BandTooltip({ keys, groupPadding, withTooltips, onPointerDown, onPointerUp }) {
	...
	const groupScale = (0, react.useMemo)(() => createGroupScale(keys, bandwidth, groupPadding), [
		keys,
		bandwidth,
		groupPadding
	]);
	const getSelections = (0, react.useCallback)((params) => {
		const point = params?.svgPoint;
	...
	(0, _visx_xychart.useEventEmitter)("pointerup", onPointerUp ? handlePointer : void 0);
	return null;
}
//#endregion
...
const validateData$2 = (data) => {
	if (!data?.length) return (0, _wordpress_i18n.__)("No data available", "jetpack-charts");
	if (data.some((series) => series.data.some((point) => isInvalidReading(point.value, { allowMissing: true }) || !point.label && (!("date" in point && point.date) || isNaN(point.date.getTime()))))) return (0, _wordpress_i18n.__)("Invalid data", "jetpack-charts");
	return null;
};
...
const BarChartInternal = ({ data, chartId: providedChartId, width, height, className, margin, withTooltips = false, showLegend = false, legend = {}, gridVisibility: gridVisibilityProp, renderTooltip, tooltipPlacement, tooltipAnchorTop, options = {}, orientation = "vertical", withPatterns = false, showZeroValues = false, withBandHighlight = false, onBandHighlightChange, defaultHiddenSeries, animation, children, gap = "md", onPointerDown, onPointerUp, onDatumActivate }) => {
	...
	const getBarBackground = (0, react.useCallback)((index) => (datum) => withPatterns ? `url(#${getPatternId(chartId, index)})` : datum.color ?? getElementStyles({
	...
	const renderDefaultTooltip = (0, react.useCallback)(({ tooltipData }) => {
		...
		if (comparisonEntry && comparisonDatum) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	const createKeyboardHighlightStyle = (0, react.useCallback)(() => {
		...
		if (!seriesData || !datum || !isBarRendered(datum)) return "";
		const domBarIndex = primaryEntries.slice(0, seriesIndex).reduce((count, { series }) => count + countRenderedBars(series.data), 0) + countRenderedBars(seriesData.data.slice(0, dataPointIndex));
		return `
			.bar-chart[data-chart-id="bar-chart-${chartId}"] .visx-bar-group .visx-bar:nth-child(${domBarIndex + 1}) {
				stroke: #005fcc;
				stroke-width: 2px;
			}
		`;
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: chartHeight > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_visx_xychart.XYChart, {
							...
							pointerEventsDataKey: "nearest",
							children: [
								withTooltips && (withBandHighlight || onBandHighlightChange) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BandHighlight, {
								...
								(withTooltips || onPointerDown || onPointerUp) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BandTooltip, {
									keys: primaryKeys,
									groupPadding,
									withTooltips,
									onPointerDown,
...
const BarListChartInternal = ({ data, width, height, options = {}, margin = {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BarChart, {
		orientation: "horizontal",
		gridVisibility: "none",
		className: (0, clsx.default)("bar-list-chart", className),
		data: tintedData,
		width,
		height,
		margin,
...
var conversion_funnel_chart_module_default = {
	...
	"change-indicator--negative": "a8ccharts-mGEVca-change-indicator--negative",
	"change-indicator--positive": "a8ccharts-mGEVca-change-indicator--positive",
...
const ConversionFunnelChartInternal = ({ mainRate, changeIndicator, steps, loading = false, animation, className, chartId: providedChartId, height, style, renderStepLabel, renderStepRate, renderMainMetric, renderTooltip }) => {
	...
	const { color: barColor } = getElementStyles ? getElementStyles({ index: 0 }) : { color: "#000000" };
	...
	const renderDefaultMainMetric = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		className: (0, clsx.default)(conversion_funnel_chart_module_default["change-indicator"], conversion_funnel_chart_module_default[isPositiveChange ? "change-indicator--positive" : "change-indicator--negative"]),
	...
	if (!isDataValid) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wordpress_ui.Stack, {
		...
		justify: "center",
		ref: setScopeNode,
		className: (0, clsx.default)("conversion-funnel-chart", conversion_funnel_chart_module_default["conversion-funnel-chart"], loading && conversion_funnel_chart_module_default["conversion-funnel-chart--loading"], className),
		style: {
			...style,
...
const GeoChartInternal = ({ className, data, width, height, region = "world", resolution = "countries", onError, renderPlaceholder }) => {
	...
	const backgroundColorHex = normalizeColorToHex(CATALOG_POINTERS.background, scopeElement, resolveCssVariable) || DEFAULT_BACKGROUND_COLOR;
	const defaultFillColorHex = normalizeColorToHex(CATALOG_POINTERS.surfaceSecondary, scopeElement, resolveCssVariable) || DEFAULT_FEATURE_FILL_COLOR;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_wordpress_ui.Stack, {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wordpress_ui.Text, {
				variant: "body-sm",
				className: heatmap_chart_module_default["heatmap-chart__legend-label"],
				style: labelStyle,
...
const HeatmapChartInternal = ({ data, chartId: providedChartId, width = 0, height = 0, className, compact = false, showValues, maxCellWidth, maxCellHeight, minCellWidth, minCellHeight, rowLabels = NO_ROW_LABELS, columnGroups, keyboardNavigation = "grid", ariaLabel, primaryColor, gap = "md", withTooltips = false, renderTooltip, tooltipVariant = "light", tooltipStyle, children }) => {
	...
	const groupLayout = (0, react.useMemo)(() => resolveColumnGroups(columnGroups, columns, 2), [columnGroups, columns]);
	...
	const getCellElement = (0, react.useCallback)((col, row) => typeof document !== "undefined" ? document.getElementById(`${chartId}-cell-${col}-${row}`) : null, [chartId]);
	...
	const defaultRenderTooltip = (0, react.useCallback)((info) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: cellName(info) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: info.value === null ? (0, _wordpress_i18n.__)("No data", "jetpack-charts") : (0, _automattic_number_formatters.formatNumber)(info.value) })] }), []);
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartInstanceContext.Provider, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ChartLayout, {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					ref: containerRef,
					role: "grid",
					"aria-label": ariaLabel ?? (0, _wordpress_i18n.__)("Heatmap chart", "jetpack-charts"),
					"aria-rowcount": rows,
					...
					style: gridStyle,
					children: [
						hasColumnLabels && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							role: "row",
							"aria-hidden": "true",
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
								...
								className: (0, clsx.default)(heatmap_chart_module_default["heatmap-chart__col-label"], {
						...
						Array.from({ length: rows }).map((_row, rowIndex) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									const accessibleLabel = `${cellName(info)}: ${info.value === null ? (0, _wordpress_i18n.__)("No data", "jetpack-charts") : (0, _automattic_number_formatters.formatNumber)(info.value)}`;
									return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										children: (drawValues || column.summary) && present && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						hasGroups && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							role: "row",
							"aria-hidden": "true",
							className: heatmap_chart_module_default["heatmap-chart__row"],
							children: groupLayout.groups.map((group, groupIndex) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const useCalendarHeatmapData = (series, options = {}) => {
	...
	return (0, react.useMemo)(() => buildCalendarHeatmapData(series, {
		locale,
		timeZone,
		weekStartsOn,
		hideOutOfRangeDays,
...
const useMonthCalendarHeatmapData = (valueByDay, range, options = {}) => {
	...
	return (0, react.useMemo)(() => buildMonthCalendarHeatmapData(valueByDay, {
		start,
		end
	}, {
		locale,
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+warning@3.55.0/node_modules/@wordpress/warning/build-module/utils.mjs
var logged = /* @__PURE__ */ new Set();
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+warning@3.55.0/node_modules/@wordpress/warning/build-module/index.mjs
function isDev() {
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/hooks/use-update-effect.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/hooks/use-cx.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/colors-values.mjs
var white = "#fff";
var GRAY = {
	900: "#1e1e1e",
	800: "#2f2f2f",
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/config-values.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/context-system-provider.mjs
var import_es6 = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function equal(a, b) {
		if (a === b) return true;
		if (a && b && typeof a == "object" && typeof b == "object") {
			if (a.constructor !== b.constructor) return false;
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/constants.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/get-styled-class-name-from-key.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/context-connect.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/utils.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/context/use-context-system.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/visually-hidden/styles.mjs
var visuallyHidden = {
	border: 0,
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/polymorphic-element.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/view/component.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/visually-hidden/component.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/utils/use-responsive-value.mjs
var breakpoints = [
	"40em",
	"52em",
	"64em"
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/grid/utils.mjs
var ALIGNMENTS = {
	bottom: {
		alignItems: "flex-end",
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/grid/hook.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/@wordpress+components@40.1.0_@date-fns+tz@1.5.0_@types+react-dom@18.3.7_@types+react@18_c300d25e93ed6b8d3659e83df7c1508a/node_modules/@wordpress/components/build-module/grid/component.mjs
...
var leaderboard_chart_module_default = {
	...
	"deltaValue--down": "a8ccharts-GovfoW-deltaValue--down",
	"deltaValue--neutral": "a8ccharts-GovfoW-deltaValue--neutral",
	"deltaValue--up": "a8ccharts-GovfoW-deltaValue--up",
...
const LeaderboardChartInternal = ({ data, chartId: providedChartId, width: propWidth, height: propHeight, withComparison = false, withOverlayLabel = false, primaryColor, secondaryColor, valueFormatter = defaultValueFormatter, deltaFormatter = defaultDeltaFormatter, animation, loading = false, fitRows = false, showLegend = false, legend = {}, legendLabels, gap = "md", className, style, children }) => {
	...
	if (!data || data.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartInstanceContext.Provider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartLayout, {
			...
			legendElement: false,
			legendChildren,
			className: (0, clsx.default)("leaderboard-chart", leaderboard_chart_module_default.leaderboardChart, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [shouldFitRows && fittedCount === 0 && !allSeriesHidden && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: data.map((entry, rowIndex) => {
						...
						const deltaTrendClass = leaderboard_chart_module_default[DELTA_TREND_CLASS[showComparisonValue ? Math.sign(entry.delta) + 1 : 1]];
						const rowCells = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wordpress_ui.Stack, {
							...
							children: [
								...
								showComparisonValue && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wordpress_ui.Text, {
									className: (0, clsx.default)(leaderboard_chart_module_default.deltaValue, deltaTrendClass),
									children: deltaFormatter(entry.delta)
								}),
								showComparisonPlaceholder && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_wordpress_ui.Text, {
									className: (0, clsx.default)(leaderboard_chart_module_default.deltaValue, leaderboard_chart_module_default.deltaPlaceholder, deltaTrendClass),
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
										children: "—"
								...
								children: (pie) => {
									return pie.arcs.map((arc, index) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
											...groupProps,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { ...pathProps }), showLabels && hasSpaceForLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
												className: pie_chart_module_default["pie-chart__label-plate"],
...
const PieSemiCircleChartInternal = ({ data, chartId: providedChartId, width: propWidth, height: propHeight, thickness = .4, clockwise = true, withTooltips = false, showLegend = false, legend = {}, legendValueDisplay = "percentage", label, animation, note, className, children, tooltipOffsetX = 0, tooltipOffsetY = -15, renderTooltip = renderDefaultPieSemiCircleTooltip, gap = "md" }) => {
	...
	if (!isValid) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("pie-semi-circle-chart", pie_semi_circle_chart_module_default["pie-semi-circle-chart"], className),
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: errorWidth,
				height: errorHeight,
...
exports.useCalendarHeatmapData = useCalendarHeatmapData;
exports.useChartFormatting = useChartFormatting;
...
exports.useMonthCalendarHeatmapData = useMonthCalendarHeatmapData;
