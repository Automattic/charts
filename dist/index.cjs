...
function useBarChartOptions(data, horizontal, options = {}) {
  ...
  return _react.useMemo.call(void 0, () => {
    ...
    const providedToolTipLabelFormatter = horizontal ? _optionalChain([options, 'access', _128 => _128.axis, 'optionalAccess', _129 => _129.y, 'optionalAccess', _130 => _130.tickFormat]) : _optionalChain([options, 'access', _131 => _131.axis, 'optionalAccess', _132 => _132.x, 'optionalAccess', _133 => _133.tickFormat]);
    const { labelOverflow: xLabelOverflow, ...xAxisOptions } = _optionalChain([options, 'access', _134 => _134.axis, 'optionalAccess', _135 => _135.x]) || {};
    const { labelOverflow: yLabelOverflow, ...yAxisOptions } = _optionalChain([options, 'access', _136 => _136.axis, 'optionalAccess', _137 => _137.y]) || {};
    return {
      gridVisibility,
      xScale,
      yScale,
...
var validateData = (data) => {
  if (!_optionalChain([data, 'optionalAccess', _138 => _138.length])) return "No data available";
...
var BarChartInternal = ({
  ...
  const totalPoints = Math.max(0, ...data.map((series) => _optionalChain([series, 'access', _139 => _139.data, 'optionalAccess', _140 => _140.length]) || 0)) * data.length;
  const {
    tooltipRef,
    onChartFocus,
    onChartBlur,
  ...
  const renderDefaultTooltip2 = _react.useCallback.call(void 0, ({
    ...
    const nearestDatum = _optionalChain([tooltipData, 'optionalAccess', _141 => _141.nearestDatum, 'optionalAccess', _142 => _142.datum]);
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", {
      ...
      children: [/* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
        ...
        children: _optionalChain([tooltipData, 'optionalAccess', _143 => _143.nearestDatum, 'optionalAccess', _144 => _144.key])
              ...
              children: [/* @__PURE__ */ _jsxruntime.jsx.call(void 0, _xychart.Grid, {
                ...
                children: seriesWithVisibility.map(({
                  ...
                  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _xychart.BarSeries, {
                    dataKey: _optionalChain([seriesData, 'optionalAccess', _145 => _145.label]),
                    data: seriesData.data,
                    yAccessor: chartOptions.accessors.yAccessor,
                    xAccessor: chartOptions.accessors.xAccessor,
                    colorAccessor: getBarBackground(index)
                  }, _optionalChain([seriesData, 'optionalAccess', _146 => _146.label]));
                })
  ...
  const handleBarClick = _react.useCallback.call(void 0, 
    (stepId) => {
      if (clickedStep === stepId) {
        setClickedStep(null);
        _optionalChain([hideTooltip, 'optionalCall', _151 => _151()]);
      } else {
  ...
  const handleBarKeyDown = _react.useCallback.call(void 0, 
    (stepId, event) => {
      if (event.key === "Enter" || event.key === " ") {
        ...
        if (clickedStep === stepId) {
          setClickedStep(null);
          _optionalChain([hideTooltip, 'optionalCall', _152 => _152()]);
        } else {
          setClickedStep(stepId);
        }
      } else if (event.key === "Escape") {
...
var ConversionFunnelChartInternal = ({
  ...
  const resolvedHeight = _nullishCoalesce(_nullishCoalesce(height, () => ( _optionalChain([style, 'optionalAccess', _155 => _155.height]))), () => ( "100%"));
  const {
    primaryColor,
    backgroundColor,
    positiveChangeColor,
  ...
  const isPositiveChange = _optionalChain([changeIndicator, 'optionalAccess', _156 => _156.startsWith, 'call', _157 => _157("+")]);
  ...
  const chartMetadata = _react.useMemo.call(void 0, () => ({
    mainRate,
    changeIndicator,
    stepsCount: _optionalChain([steps, 'optionalAccess', _158 => _158.length]) || 0
  }), [mainRate, changeIndicator, _optionalChain([steps, 'optionalAccess', _159 => _159.length])]);
  useChartRegistration({
    chartId,
    legendItems: [],
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/utils/values.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/utils/colors.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/utils/space.mjs
var GRID_BASE = "4px";
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/truncate/styles.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/truncate/utils.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/truncate/hook.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/styles.mjs
var styles_exports2 = {};
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/utils.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/utils/font-size.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/get-line-height.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/hook.mjs
...
// ../../../node_modules/.pnpm/@wordpress+components@32.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/component.mjs
