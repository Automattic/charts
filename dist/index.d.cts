...
type ThemeAnnotationStyles = {
  ...
  label?: Omit<LabelProps, 'title' | 'subtitle' | 'x' | 'y' | 'anchorLineStroke' | 'backgroundFill'> & {
    x?: number | 'start' | 'end';
    y?: number | 'start' | 'end';
  };
};
...
type ChartTheme = {
  ...
  gridStyles?: Omit<GridStyles$1, 'stroke'>;
  /** Length of axis ticks in pixels */
  tickLength: number;
  /** Styles for x-axis tick lines */
  xTickLineStyles?: Omit<LineStyles$1, 'stroke'>;
  /** Styles for x-axis line */
  xAxisLineStyles?: Omit<LineStyles$1, 'stroke'>;
  /**
   ...
   */
  seriesLineStyles?: Array<Omit<LineStyles$1, 'stroke'>>;
  ...
  lineChart?: {
    lineStyles?: Partial<Record<NonNullable<SeriesDataOptions['type']>, Omit<LineStyles$1, 'stroke'>>>;
  };
  barChart?: {
...
type CompleteChartTheme = Required<ChartTheme> & {
  ...
  lineChart: {
    lineStyles: Record<NonNullable<SeriesDataOptions['type']>, Omit<LineStyles$1, 'stroke'>>;
  };
  barChart: {
 ...
 */
interface SeriesVisibilityProps {
  /**
...
type TooltipPlacement = 'auto' | 'below-axis' | 'beside';
type CrosshairPaintProperty = 'stroke' | 'strokeWidth' | 'strokeOpacity' | 'strokeDasharray' | 'strokeLinecap' | 'opacity';
type CrosshairStyle = Pick<SVGProps<SVGLineElement>, CrosshairPaintProperty> & {
  className?: string;
...
} & Omit<TooltipProps$1, 'left' | 'top' | 'children' | 'applyPositionStyle'>;
//#endregion
...
type MonthCalendarHeatmapOptions = {
...
//#endregion
//#region src/charts/heatmap-chart/build-month-calendar-data.d.ts
/**
 ...
 */
declare const buildMonthCalendarHeatmapData: (valueByDay: Record<string, number | null>, range: MonthCalendarHeatmapRange, options?: MonthCalendarHeatmapOptions) => MonthCalendarHeatmapResult;
//#endregion
...
//#endregion
//#region src/charts/heatmap-chart/use-month-calendar-heatmap-data.d.ts
/**
 ...
 */
declare const useMonthCalendarHeatmapData: (valueByDay: Record<string, number | null>, range: MonthCalendarHeatmapRange, options?: MonthCalendarHeatmapOptions) => MonthCalendarHeatmapResult;
//#endregion
...
//#endregion
//#region src/utils/resolve-css-var.d.ts
/**
...
//#endregion
//#region src/providers/chart-scope/use-chart-scope-element.d.ts
/**
