...
interface LeaderboardChartProps extends Pick<BaseChartProps<LeaderboardEntry>, 'className' | 'data'> {
    /**
...
export { LeaderboardChart as L, type LeaderboardChartProps as a };
