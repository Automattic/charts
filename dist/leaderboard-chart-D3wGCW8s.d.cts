...
import { B as BaseLegendProps, a as BaseLegendItem } from './types-4lieC41v.cjs';
import { B as BaseChartProps, L as LeaderboardEntry } from './types-pVkkGIaQ.cjs';
...
declare const LeaderboardChartResponsive: (({ resizeDebounceTime, maxWidth, aspectRatio, ...chartProps }: Pick<Partial<LeaderboardChartProps>, "width" | "height" | "size"> & Omit<LeaderboardChartProps, "width" | "height" | "size"> & ResponsiveConfig) => react_jsx_runtime.JSX.Element) & {
    Legend: react.ForwardRefExoticComponent<Omit<BaseLegendProps, "items"> & {
        items?: BaseLegendItem[];
        chartId?: string;
    } & react.RefAttributes<HTMLDivElement>>;
