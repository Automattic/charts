 ...
 */
export declare function withResponsive<T extends BaseChartProps<unknown>>(WrappedComponent: ComponentType<T>, config?: ResponsiveConfig): (props: Omit<T, "width" | "height" | "size">) => import("react/jsx-runtime").JSX.Element;
export {};
